  ...
  var e,
    ...
    n = {
        ...
        (THREE.EditorControls = function (e, t) {
          ...
          (this.focus = function (e) {
            ...
            a.setFromObject(e),
              !1 !== a.isEmpty() || isNaN(a.min.x)
                ...
                : (a.getCenter(c), (t = a.getBoundingSphere(h).radius)),
              n.position.copy(
                e.localToWorld(new THREE.Vector3(0, c.y + 0.5 * t, 2.5 * t))
              );
            const o = e.getWorldPosition(new THREE.Vector3());
            (o.y = c.y), n.lookAt(o), r.dispatchEvent(m);
          }),
            (this.pan = function (e) {
              var t;
          ...
          function v(e) {
            !1 !== r.enabled &&
              ...
              t.addEventListener('mousemove', y, !1),
              t.addEventListener('mouseup', b, !1),
              t.addEventListener('mouseout', b, !1),
              t.addEventListener('dblclick', b, !1));
          }
          function y(e) {
            if (!1 !== r.enabled) {
          ...
          function b(e) {
            t.removeEventListener('mousemove', y, !1),
              t.removeEventListener('mouseup', b, !1),
              t.removeEventListener('mouseout', b, !1),
              t.removeEventListener('dblclick', b, !1),
              (l = s.NONE);
          }
          function A(e) {
          ...
          (this.setAspectRatio = function (e) {
            ...
            (this.dispose = function () {
              t.removeEventListener('contextmenu', C, !1),
                t.removeEventListener('mousedown', v, !1),
                t.removeEventListener('wheel', A, !1),
                t.removeEventListener('mousemove', y, !1),
                t.removeEventListener('mouseup', b, !1),
                t.removeEventListener('mouseout', b, !1),
                t.removeEventListener('dblclick', b, !1),
                t.removeEventListener('touchstart', M, !1),
              ...
              switch (
                ...
                case 1:
                  x[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                    x[1].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                    r.rotate(
                      x[0].sub(a(x[0], E)).multiplyScalar(-r.rotationSpeed)
                    );
                  break;
                case 2:
                  x[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                  ...
                  r.zoom(i.set(0, 0, w - t)), (w = t);
                  var n = x[0].clone().sub(a(x[0], E)),
                    o = x[1].clone().sub(a(x[1], E));
                  (n.x = -n.x),
                    (o.x = -o.x),
      ...
      259: () => {
        !(function () {
          'use strict';
          class e extends THREE.MeshBasicMaterial {
            constructor(e) {
              super(),
                (this.depthTest = !1),
                (this.depthWrite = !1),
          ...
          class t extends THREE.LineBasicMaterial {
            constructor(e) {
              super(),
                (this.depthTest = !1),
                (this.depthWrite = !1),
          ...
          (THREE.TransformGizmo = class extends THREE.Object3D {
            init() {
              ...
              n))
                (n[r].name = r), this.planes.add(n[r]), (this.planes[r] = n[r]);
              var o = function (e, t) {
                for (var n in e)
                  for (r = e[n].length; r--; ) {
                    var o = e[n][r][0],
            ...
            (THREE.TransformGizmoTranslate = class extends (
                ...
                a.setAttribute(
                  ...
                  (this.handleGizmos = {
                    X: [
                      ...
                      [new THREE.Line(o, new t({ color: 16711680 }))]
                    ],
                    Y: [
                      [new THREE.Mesh(r, new e({ color: 65280 })), [0, 0.5, 0]],
                      [new THREE.Line(i, new t({ color: 65280 }))]
                    ],
                    Z: [
                      [
                      ...
                      [new THREE.Line(a, new t({ color: 255 }))]
                    ],
                    XYZ: [
                      [
                        new THREE.Mesh(
                  ...
                  (this.pickerGizmos = {
                    ...
                    XYZ: [
                      [new THREE.Mesh(new THREE.OctahedronGeometry(0.2, 0), n)]
                    ],
                    XY: [
                      [
                        new THREE.Mesh(new THREE.PlaneGeometry(0.4, 0.4), n),
                        [0.2, 0.2, 0]
                      ]
                    ],
                    YZ: [
              ...
              setActivePlane(e, t) {
                ...
                t.applyMatrix4(
                  n.copy(n.extractRotation(this.planes.XY.matrixWorld)).invert()
                ),
                  'X' === e &&
            ...
            (THREE.TransformGizmoRotate = class extends THREE.TransformGizmo {
              constructor() {
                ...
                (this.handleGizmos = {
                  ...
                  Z: [
                    [new THREE.Line(new e(1, 'z', 0.5), new t({ color: 255 }))]
                  ],
                  E: [
                    [
                      new THREE.Line(
              ...
              update(e, t) {
                ...
                var n = new THREE.Matrix4(),
                  ...
                  p = t.clone();
                r.copy(this.planes.XY.rotation),
                  o.setFromEuler(r),
                  n.makeRotationFromQuaternion(o).copy(n).invert(),
                  p.applyMatrix4(n),
                  this.traverse(function (e) {
                    o.setFromEuler(r),
                      'X' === e.name &&
                        (l.setFromAxisAngle(i, Math.atan2(-p.y, p.z)),
                        o.multiplyQuaternions(o, l),
                        e.quaternion.copy(o)),
                      'Y' === e.name &&
                        (c.setFromAxisAngle(a, Math.atan2(p.x, p.z)),
                        o.multiplyQuaternions(o, c),
                        e.quaternion.copy(o)),
                      'Z' === e.name &&
                        (u.setFromAxisAngle(s, Math.atan2(p.y, p.x)),
                        o.multiplyQuaternions(o, u),
                        e.quaternion.copy(o));
                  });
              }
            }),
              ...
              constructor() {
                ...
                a.setAttribute(
                  ...
                  (this.pickerGizmos = {
                    ...
                    XYZ: [
                      [new THREE.Mesh(new THREE.BoxGeometry(0.4, 0.4, 0.4), n)]
                    ]
                  }),
                  this.init();
              }
            ...
            (THREE.TransformControls = class extends THREE.Object3D {
              constructor(e, t) {
                ...
                for (var s in a) {
                  var l = a[s];
                  (l.visible = s === o), this.add(l);
                }
                var c = { type: 'change' },
                  u = { type: 'mouseDown' },
                  p = { type: 'mouseUp', mode: o },
                  d = { type: 'objectChange' },
                ...
                function W(e) {
                  if (
                    ...
                    var t = G(
                        ...
                        a[o].pickers.children
                      ),
                      n = null;
                    t && ((n = t.object.name), e.preventDefault()),
                      r.axis !== n &&
                        ((r.axis = n), r.update(), r.dispatchEvent(c));
                  }
                }
                function Y(e) {
                  if (
                    ...
                    if (0 === t.button || void 0 === t.button) {
                      var n = G(t, a[o].pickers.children);
                      if (n) {
                        e.preventDefault(),
                          e.stopPropagation(),
                          ...
                          r.dispatchEvent(u),
                          r.update(),
                          C.copy(H).sub(F).normalize(),
                          a[o].setActivePlane(r.axis, C);
                        var s = G(t, [a[o].activePlane]);
                        s &&
                          (L.copy(r.object.position),
                          P.copy(r.object.scale),
                          z.extractRotation(r.object.matrix),
                          U.extractRotation(r.object.matrixWorld),
                          B.extractRotation(r.object.parent.matrixWorld),
                          D.setFromMatrixScale(
                            x.copy(r.object.parent.matrixWorld).invert()
                          ),
                          g.copy(s.point));
                      }
                    }
                ...
                function Q(e) {
                  if (
                    ...
                    var t = G(e.changedTouches ? e.changedTouches[0] : e, [
                      a[o].activePlane
                    ]);
                    if (!1 !== t) {
                      if (
                        ...
                        m.sub(g),
                          m.multiply(D),
                          'local' === r.space &&
                            (m.applyMatrix4(x.copy(U).invert()),
                            -1 === r.axis.search('X') && (m.x = 0),
                            -1 === r.axis.search('Y') && (m.y = 0),
                            -1 === r.axis.search('Z') && (m.z = 0),
                            m.applyMatrix4(z),
                            r.object.position.copy(L),
                            r.object.position.add(m)),
                          ('world' !== r.space &&
                            -1 === r.axis.search('XYZ')) ||
                            (-1 === r.axis.search('X') && (m.x = 0),
                            -1 === r.axis.search('Y') && (m.y = 0),
                            -1 === r.axis.search('Z') && (m.z = 0),
                            m.applyMatrix4(x.copy(B).invert()),
                            r.object.position.copy(L),
                            r.object.position.add(m)),
                          null !== r.translationSnap &&
                            ('local' === r.space &&
                              r.object.position.applyMatrix4(
                                x.copy(U).invert()
                              ),
                            -1 !== r.axis.search('X') &&
                              (r.object.position.x =
                                Math.round(
                                  r.object.position.x / r.translationSnap
                                ) * r.translationSnap),
                            -1 !== r.axis.search('Y') &&
                              (r.object.position.y =
                                Math.round(
                                  r.object.position.y / r.translationSnap
                                ) * r.translationSnap),
                            -1 !== r.axis.search('Z') &&
                              (r.object.position.z =
                                Math.round(
                                  r.object.position.z / r.translationSnap
                                ) * r.translationSnap),
                            'local' === r.space &&
                              r.object.position.applyMatrix4(U));
                      else if ('scale' === o)
                        m.sub(g),
                          m.multiply(D),
                          'local' === r.space &&
                            ('XYZ' === r.axis
                              ? ((b = 1 + m.y / Math.max(P.x, P.y, P.z)),
                                (r.object.scale.x = P.x * b),
                                (r.object.scale.y = P.y * b),
                                (r.object.scale.z = P.z * b))
                              : (m.applyMatrix4(x.copy(U).invert()),
                                'X' === r.axis &&
                                  (r.object.scale.x = P.x * (1 + m.x / P.x)),
                                'Y' === r.axis &&
                                  (r.object.scale.y = P.y * (1 + m.y / P.y)),
                                'Z' === r.axis &&
                                  (r.object.scale.z = P.z * (1 + m.z / P.z))));
                      else if ('rotate' === o)
                        if (
                          (m.sub(F),
                          m.multiply(D),
                          ...
                          m.applyMatrix4(x.copy(A).invert()),
                            E.applyMatrix4(x.copy(A).invert()),
                            v.set(
                              Math.atan2(m.z, m.y),
                              Math.atan2(m.x, m.z),
                              Math.atan2(m.y, m.x)
                            ...
                            w.setFromRotationMatrix(x.copy(B).invert()),
                            j.setFromAxisAngle(C, v.z - y.z),
                            I.setFromRotationMatrix(U),
                            w.multiplyQuaternions(w, j),
                            w.multiplyQuaternions(w, I),
                            r.object.quaternion.copy(w);
                        else if ('XYZE' === r.axis) {
                          var n = m.clone().cross(E).normalize();
                          j.setFromEuler(M.set(n.x, n.y, n.z)),
                            w.setFromRotationMatrix(x.copy(B).invert()),
                            R.setFromAxisAngle(j, -m.clone().angleTo(E)),
                            I.setFromRotationMatrix(U),
                            w.multiplyQuaternions(w, R),
                            w.multiplyQuaternions(w, I),
                            r.object.quaternion.copy(w);
                        } else
                          'local' === r.space
                            ? (m.applyMatrix4(x.copy(U).invert()),
                              E.applyMatrix4(x.copy(U).invert()),
                              v.set(
                                Math.atan2(m.z, m.y),
                                Math.atan2(m.x, m.z),
                                Math.atan2(m.y, m.x)
                              ...
                              I.setFromRotationMatrix(z),
                              null !== r.rotationSnap
                                ? (R.setFromAxisAngle(
                                    S,
                                    Math.round((v.x - y.x) / r.rotationSnap) *
                                      r.rotationSnap
                                  ),
                                  O.setFromAxisAngle(
                                    k,
                                    Math.round((v.y - y.y) / r.rotationSnap) *
                                      r.rotationSnap
                                  ),
                                  N.setFromAxisAngle(
                                    T,
                                    Math.round((v.z - y.z) / r.rotationSnap) *
                                      r.rotationSnap
                                  ))
                                : (R.setFromAxisAngle(S, v.x - y.x),
                                  O.setFromAxisAngle(k, v.y - y.y),
                                  N.setFromAxisAngle(T, v.z - y.z)),
                              'X' === r.axis && I.multiplyQuaternions(I, R),
                              'Y' === r.axis && I.multiplyQuaternions(I, O),
                              'Z' === r.axis && I.multiplyQuaternions(I, N),
                            ...
                            : 'world' === r.space &&
                              ...
                              null !== r.rotationSnap
                                ...
                                : (R.setFromAxisAngle(S, v.x - y.x),
                                  ...
                                  N.setFromAxisAngle(T, v.z - y.z)),
                              I.setFromRotationMatrix(U),
                              'X' === r.axis && w.multiplyQuaternions(w, R),
                              'Y' === r.axis && w.multiplyQuaternions(w, O),
                              'Z' === r.axis && w.multiplyQuaternions(w, N),
                              w.multiplyQuaternions(w, I),
                              r.object.quaternion.copy(w));
                      'translate' === o
                        ? ((r.object.position.x = parseFloat(
                            r.object.position.x.toFixed(5)
                          )),
                          (r.object.position.y = parseFloat(
                            r.object.position.y.toFixed(5)
                          )),
                          (r.object.position.z = parseFloat(
                            r.object.position.z.toFixed(5)
                          )))
                        : 'rotate' === o
                          ? ((r.object.rotation.x = parseFloat(
                              r.object.rotation.x.toFixed(5)
                            )),
                            (r.object.rotation.y = parseFloat(
                              r.object.rotation.y.toFixed(5)
                            )),
                            (r.object.rotation.z = parseFloat(
                              r.object.rotation.z.toFixed(5)
                            )))
                          : ((r.object.scale.x = parseFloat(
                              r.object.scale.x.toFixed(5)
                            )),
                            (r.object.scale.y = parseFloat(
                              r.object.scale.y.toFixed(5)
                            )),
                            (r.object.scale.z = parseFloat(
                              r.object.scale.z.toFixed(5)
                            ))),
                        r.update(),
                        r.dispatchEvent(c),
                        (d.mode = o),
                ...
                function $(e) {
                  e.preventDefault(),
                    (void 0 !== e.button && 0 !== e.button) ||
                      (i &&
                        null !== r.axis &&
                        ((p.mode = o), r.dispatchEvent(p)),
                      (i = !1),
                      'TouchEvent' in window && e instanceof TouchEvent
                        ? ((r.axis = null), r.update(), r.dispatchEvent(c))
                        : W(e));
                }
                function G(e, r) {
                  var o = t.getBoundingClientRect(),
                    i = (e.clientX - o.left) / o.width,
                    a = (e.clientY - o.top) / o.height;
                  h.set(2 * i - 1, -2 * a + 1), f.setFromCamera(h, n);
                  var s = f.intersectObjects(r, !0);
                  return !!s[0] && s[0];
                }
                (this.setCamera = function (e) {
                  n = e;
                  ...
                  (this.activate = function () {
                    t.addEventListener('mousedown', Y, !1),
                      ...
                      t.addEventListener('mousemove', W, !1),
                      t.addEventListener('touchmove', W, !1),
                      t.addEventListener('mousemove', Q, !1),
                      t.addEventListener('touchmove', Q, !1),
                      t.addEventListener('mouseup', $, !1),
                      t.addEventListener('mouseout', $, !1),
                      t.addEventListener('touchend', $, !1),
                      t.addEventListener('touchcancel', $, !1),
                      t.addEventListener('touchleave', $, !1);
                  }),
                  this.activate(),
                  (this.dispose = function () {
                  ...
                  (this.setMode = function (e) {
                    for (var t in ('scale' === (o = e || o) &&
                      (r.space = 'local'),
                    a))
                      a[t].visible = t === o;
                    this.update(), r.dispatchEvent(c);
                  }),
                  ...
                  (this.setSize = function (e) {
                    (r.size = e), this.update(!0), r.dispatchEvent(c);
                  }),
                  (this.setSpace = function (e) {
                    (r.space = e), this.update(), r.dispatchEvent(c);
                  }),
                  (this.update = function (e) {
                    void 0 !== r.object &&
                      (r.object.updateMatrixWorld(),
                      F.setFromMatrixPosition(r.object.matrixWorld),
                      _.setFromRotationMatrix(
                        x.extractRotation(r.object.matrixWorld)
                      ),
                      n.updateMatrixWorld(),
                      H.setFromMatrixPosition(n.matrixWorld),
                      V.setFromRotationMatrix(x.extractRotation(n.matrixWorld)),
                      (b = (F.distanceTo(H) / 6) * r.size),
                      this.position.copy(F),
                      e && this.scale.set(b, b, b),
                      n instanceof THREE.PerspectiveCamera
                        ? C.copy(H).sub(F).normalize()
                        : n instanceof THREE.OrthographicCamera &&
                          C.copy(H).normalize(),
                      'local' === r.space
                        ? a[o].update(_, C)
                        : 'world' === r.space &&
                          a[o].update(new THREE.Euler(), C),
                      a[o].highlight(r.axis));
                  });
              }
            });
        })();
        ...
        e.exports = function (e, t, n) {
          ...
          function x() {
            ...
            if (((r = arguments), (o = this), (l = e), n)) {
              if (void 0 === s)
                return (function (e) {
                  return (c = e), (s = setTimeout(A, t)), u ? y(e) : a;
                })(l);
              if (p) return (s = setTimeout(A, t)), y(l);
            }
          ...
          return (
            ...
            m(n) &&
              ((u = !!n.leading),
              (i = (p = 'maxWait' in n) ? d(g(n.maxWait) || 0, t) : i),
      ...
      551: (e, t, n) => {
        ...
        function Ue(e, t, n, r, o, i, a, s, l) {
          (ze = !1), (Be = null), Pe.apply(_e, arguments);
        }
        function He(e) {
          var t = e,
            n = e;
        ...
        function Dt(e) {
          ...
          for (var t = e.targetContainers; 0 < t.length; ) {
            ...
            if (null !== n)
              return null !== (t = Ao(n)) && xt(t), (e.blockedOn = n), !1;
        ...
        function $t(e, t, n, r) {
          if (Wt) {
            var o = Zt(e, t, n, r);
            if (null === o) Wr(e, t, r, Gt, n), Pt(e, r);
            else if (
              (function (e, t, n, r, o) {
                switch (t) {
                  case 'focusin':
                  ...
                  case 'pointerover':
                    var i = o.pointerId;
                    return Ot.set(i, zt(Ot.get(i) || null, e, t, n, r, o)), !0;
                  case 'gotpointercapture':
                    return (
                      (i = o.pointerId),
              ...
              for (; null !== o; ) {
                ...
                if (
                  (null !== i && Ct(i),
                  null === (i = Zt(e, t, n, r)) && Wr(e, t, r, Gt, n),
                  i === o)
                )
                  break;
                o = i;
        ...
        var zn = u && 'TextEvent' in window && !Pn,
          Bn = u && (!Ln || (Pn && 8 < Pn && 11 >= Pn)),
        ...
        var Sr = Mr('animationend'),
          kr = Mr('animationiteration'),
            ...
            if (0 == (7 & t)) {
              if (
                ...
                if (
                  ...
                  (p = null == l ? s : Co(l)),
                  (f = null == c ? s : Co(c)),
                  ((s = new u(m, h + 'leave', l, n, o)).target = p),
                  (s.relatedTarget = f),
                  (m = null),
                  bo(o) === r &&
                    (((u = new u(d, h + 'enter', c, n, o)).target = f),
                    (u.relatedTarget = p),
                    (m = u)),
                  (p = m),
                  l && c)
                  ...
                  e: {
                    for (d = c, h = 0, f = u = l; f; f = $r(f)) h++;
                    for (f = 0, m = d; m; m = $r(m)) f++;
                    for (; 0 < h - f; ) (u = $r(u)), h--;
                    for (; 0 < f - h; ) (d = $r(d)), f--;
                    for (; h--; ) {
              ...
              b &&
                ...
                (y = zn
                  ...
                  : (function (e, t) {
                      if (Hn)
                        return 'compositionend' === e || (!Ln && _n(e, t))
                          ? ((e = en()), (Jt = Kt = qt = null), (Hn = !1), e)
                          : null;
                      switch (e) {
                        case 'paste':
                        default:
        ...
        function Qr(e, t) {
          for (var n = t + 'Capture', r = []; null !== e; ) {
            ...
            5 === o.tag &&
              null !== i &&
              ((o = i),
              null != (i = Ne(e, n)) && r.unshift(Yr(e, i, o)),
              null != (i = Ne(e, t)) && r.push(Yr(e, i, o))),
              (e = e.return);
          }
          return r;
        }
        ...
        function Gr(e, t, n, r, o) {
          for (var i = t._reactName, a = []; null !== n && n !== r; ) {
            ...
            5 === s.tag &&
              ...
              ((s = c),
              o
                ? null != (l = Ne(n, i)) && a.unshift(Yr(n, l, s))
                : o || (null != (l = Ne(n, i)) && a.push(Yr(n, l, s)))),
              (n = n.return);
          }
        ...
        function So(e) {
          0 > wo || ((e.current = Eo[wo]), (Eo[wo] = null), wo--);
        }
        function ko(e, t) {
          wo++, (Eo[wo] = e.current), (e.current = t);
        }
        var To = {},
          Io = Mo(To),
          Ro = Mo(!1),
        ...
        function Vo() {
          if (!Uo && null !== Fo) {
            ...
            try {
              ...
              throw (null !== Fo && (Fo = Fo.slice(e + 1)), $e(Je, Vo), t);
            } finally {
              (bt = t), (Uo = !1);
            }
          }
        ...
        function ei(e, t, n) {
          (Go[Zo++] = qo), (Go[Zo++] = Ko), (Go[Zo++] = Xo), (Xo = e);
          var r = qo;
          e = Ko;
          var o = 32 - at(r) - 1;
          (r &= ~(1 << o)), (n += 1);
        ...
        function Si(e) {
          ...
          if (Ci !== e)
            if (
              ...
              (Ai = e), (bi.dependencies = { lanes: 0, firstContext: e });
            } else Ai = Ai.next = e;
          return t;
        }
        var ki = null;
        ...
        var Hi = {
          ...
          enqueueSetState: function (e, t, n) {
            ...
            (i.payload = t),
              null != n && (i.callback = n),
              null !== (t = Pi(e, i, o)) && (rc(t, e, o, r), zi(t, e, o));
          },
          ...
          enqueueForceUpdate: function (e, t) {
            ...
            (o.tag = 2),
              null != t && (o.callback = t),
              null !== (t = Pi(e, o, r)) && (rc(t, e, r, n), zi(t, e, r));
          }
        };
        ...
        function Qi(e, t, n, r) {
          var o = e.stateNode;
          (o.props = n), (o.state = e.memoizedState), (o.refs = _i), Ni(e);
          var i = t.contextType;
          'object' == typeof i && null !== i
            ? (o.context = Si(i))
            : ((i = jo(t) ? Oo : Io.current), (o.context = No(e, i))),
        ...
        function Xi(e) {
          ...
          function c(e, t, n, r) {
            ...
            return i === E
              ...
              : null !== t &&
                ...
                : (((r = Pc(n.type, n.key, n.props, null, e.mode, r)).ref = $i(
                    e,
                    t,
                    n
                  )),
          ...
          function d(e, t, n) {
            ...
            if ('object' == typeof t && null !== t) {
              switch (t.$$typeof) {
                case C:
                  return (
                    ((n = Pc(t.type, t.key, t.props, null, e.mode, n)).ref = $i(
                      e,
                      null,
                      t
                    )),
          ...
          function f(e, t, n, r) {
            ...
            if ('object' == typeof n && null !== n) {
              ...
              if (te(n) || P(n)) return null !== o ? null : p(e, t, n, r, null);
              Gi(e, n);
            }
            return null;
          }
          ...
          function m(o, i, s, l) {
            ...
            if (m === s.length) return n(o, p), ii && Jo(o, m), c;
            if (null === p) {
              for (; m < s.length; m++)
                null !== (p = d(o, s[m], l)) &&
                  ((i = a(p, i, m)),
          ...
          function g(o, s, l, c) {
            ...
            for (
              var p = (u = null), m = s, g = (s = 0), v = null, y = l.next();
              null !== m && !y.done;
              g++, y = l.next()
            ) {
            ...
            if (y.done) return n(o, m), ii && Jo(o, g), u;
            if (null === m) {
              ...
              switch (a.$$typeof) {
                case C:
                  e: {
                    ...
                    a.type === E
                      ? (((i = zc(a.props.children, r.mode, l, a.key)).return =
                          r),
                        (r = i))
                      : (((l = Pc(
                          a.type,
        ...
        var da = A.ReactCurrentDispatcher,
          fa = A.ReactCurrentBatchConfig,
          ha = 0,
          ma = null,
          ga = null,
          va = null,
        ...
        function wa(e, t, n, r, o, a) {
          if (
            ...
            a = 0;
            do {
              if (((ba = !1), (Aa = 0), 25 <= a)) throw Error(i(301));
              (a += 1),
                (va = ga = null),
                (t.updateQueue = null),
                (da.current = cs),
        ...
        function Ia(e) {
          ...
          if (null !== (e = n.interleaved)) {
            o = e;
            do {
              (a = o.lane), (ma.lanes |= a), (Bl |= a), (o = o.next);
            } while (o !== e);
        ...
        function Ka(e, t, n) {
          return 0 == (21 & ha)
            ? (e.baseState && ((e.baseState = !1), (As = !0)),
              (e.memoizedState = n))
            : (sr(n, t) ||
                ((n = mt()), (ma.lanes |= n), (Bl |= n), (e.baseState = !0)),
              t);
        }
        function Ja(e, t) {
          var n = bt;
        ...
        var as = {
          ...
          ls = {
            ...
            useDebugValue: Za,
            useDeferredValue: function (e) {
              return Ka(ka(), ga.memoizedState, e);
            },
            useTransition: function () {
              return [Ia(Ta)[0], ka().memoizedState];
            },
            useMutableSource: Oa,
          ...
          cs = {
            ...
            useTransition: function () {
              return [Ra(Ta)[0], ka().memoizedState];
            },
            useMutableSource: Oa,
            useSyncExternalStore: Na,
            useId: es,
            ...
            ? (e === t
                ...
                : ((e.flags |= 128),
                  ...
                  1 === n.tag &&
                    (null === n.alternate
                      ? (n.tag = 17)
                      : (((t = Li(-1, 1)).tag = 2), Pi(n, t, 1))),
                  (n.lanes |= 1)),
              e)
            : ((e.flags |= 65536), (e.lanes = o), e);
        }
        var bs = A.ReactCurrentOwner,
          As = !1;
        function Cs(e, t, n, r) {
        ...
        function Es(e, t, n, r, o) {
          if (null === e) {
            ...
            return 'function' != typeof i ||
              ...
              ? (((e = Pc(n.type, null, r, t, t.mode, o)).ref = t.ref),
                (e.return = t),
                (t.child = e))
              : ((t.tag = 15), (t.type = i), ws(e, t, i, r, o));
          }
        ...
        function Ts(e, t, n, r, o) {
          ...
          if ((Mi(t, o), null === t.stateNode))
            ...
            (a.state = d),
              Di(t, r, a, o),
              (l = t.memoizedState),
              s !== r || d !== l || Ro.current || Oi
                ? ('function' == typeof u &&
                    (Ui(t, n, u, r), (l = t.memoizedState)),
                  (s = Oi || Vi(t, n, s, r, d, l, c))
                    ? (p ||
            ...
            s !== p || d !== h || Ro.current || Oi
              ? ('function' == typeof f &&
                  (Ui(t, n, f, r), (h = t.memoizedState)),
                (c = Oi || Vi(t, n, c, r, d, h, l) || !1)
                  ? (u ||
        ...
        function Os(e, t, n, r, o) {
          return hi(), mi(o), (t.flags |= 256), Cs(e, t, n, r), t.child;
        }
        var Ns,
          js,
          Ls,
        ...
        function Ds(e, t, n) {
          ...
          if (null !== (a = e.memoizedState) && null !== (r = a.dehydrated))
            return (function (e, t, n, r, o, a, s) {
              if (n)
                return 256 & t.flags
                  ? ((t.flags &= -257), _s(e, t, s, (r = ps(Error(i(422))))))
              ...
              if ('$!' === o.data) {
                if ((r = o.nextSibling && o.nextSibling.dataset))
                  var l = r.dgst;
                return (
                  (r = l), _s(e, t, s, (r = ps((a = Error(i(419))), r, void 0)))
                );
              }
              if (((l = 0 != (s & e.childLanes)), As || l)) {
                if (null !== (r = Rl)) {
                  ...
                  0 !== (o = 0 != (o & (r.suspendedLanes | s)) ? 0 : o) &&
                    o !== a.retryLane &&
                    ((a.retryLane = o), Ri(e, o), rc(r, e, o, -1));
                }
                return gc(), _s(e, t, s, (r = ps(Error(i(421)))));
              }
              return '$?' === o.data
                ? ((t.flags |= 128),
                  (t.child = e.child),
        ...
        function Gs(e, t, n) {
          ...
          switch ((ni(t), t.tag)) {
              ...
              if (((n = t.type), null !== e && null != t.stateNode))
                ...
                if (((e = ra(ea.current)), di(t))) {
                  ...
                  switch (
                    ...
                    case 'video':
                    case 'audio':
                      for (o = 0; o < Pr.length; o++) Fr(Pr[o], r);
                      break;
                    case 'source':
                      Fr('error', r);
                      break;
                  ...
                  e: {
                    switch (((l = be(n, r)), n)) {
                      ...
                      case 'video':
                      case 'audio':
                        for (o = 0; o < Pr.length; o++) Fr(Pr[o], e);
                        o = r;
                        break;
                      case 'source':
                        Fr('error', e), (o = r);
            ...
            case 10:
              return Ei(t.type._context), $s(t), null;
            case 19:
        ...
        var wl,
          ...
          ec = 0;
        function tc() {
          return 0 != (6 & Il) ? qe() : -1 !== Jl ? Jl : (Jl = qe());
        }
        function nc(e) {
          return 0 == (1 & e.mode)
            ? 1
        ...
        function ic(e, t) {
          if (((Jl = -1), (ec = 0), 0 != (6 & Il))) throw Error(i(327));
          var n = e.callbackNode;
          ...
          if (0 !== t) {
            if (
              ...
              throw ((n = zl), fc(e, 0), lc(e, r), oc(e, qe()), n);
            if (6 === t) lc(e, r);
            else {
              if (
              ...
              switch (((e.finishedWork = o), (e.finishedLanes = r), t)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = ro(xc.bind(null, e, Ul, Wl), t);
                    break;
                  }
                  xc(e, Ul, Wl);
                  break;
                case 4:
                  ...
                  if (
                    ...
                    e.timeoutHandle = ro(xc.bind(null, e, Ul, Wl), r);
                    break;
                  }
                  xc(e, Ul, Wl);
                  break;
        ...
        function cc(e) {
          ...
          if (1 === n) throw ((n = zl), fc(e, 0), lc(e, t), oc(e, qe()), n);
        ...
        function uc(e, t) {
          ...
          try {
            ...
            0 === (Il = n) && ((Vl = qe() + 500), _o && Vo());
          }
        }
        function pc(e) {
          null !== Zl && 0 === Zl.tag && 0 == (6 & Il) && Ec();
          var t = Il;
          Il |= 1;
          var n = Tl.transition,
            r = bt;
          try {
            ...
            (bt = r), (Tl.transition = n), 0 == (6 & (Il = t)) && Vo();
          }
        }
        function dc() {
          (jl = Ll.current), So(Ll);
        ...
        function vc(e, t) {
          ...
          if ((xi(), (Il = n), (Sl.current = r), null !== Ol))
            throw Error(i(261));
          return (Rl = null), (Nl = 0), Pl;
        }
        function yc() {
          for (; null !== Ol; ) Ac(Ol);
        }
        function bc() {
          for (; null !== Ol && !Ze(); ) Ac(Ol);
        }
        function Ac(e) {
        ...
        function Cc(e) {
          ...
          do {
            ...
            if (((e = t.return), 0 == (32768 & t.flags))) {
              if (null !== (n = Gs(n, t, jl))) return void (Ol = n);
            } else {
              if (null !== (n = Zs(n, t)))
        ...
        function Ec() {
          if (null !== Zl) {
            var e = At(Xl),
              ...
              n = bt;
            try {
              if (((Tl.transition = null), (bt = 16 > e ? 16 : e), null === Zl))
                var r = !1;
              else {
                if (((e = Zl), (Zl = null), (Xl = 0), 0 != (6 & Il)))
                  throw Error(i(331));
                var o = Il;
        ...
        function Sc(e, t, n) {
          ...
          null !== r && r.delete(t),
            ...
            Rl === e &&
              (Nl & n) === n &&
              (4 === Pl ||
              (3 === Pl && (130023424 & Nl) === Nl && 500 > qe() - Hl)
                ? fc(e, 0)
                : (Fl |= n)),
            oc(e, t);
        }
        ...
        function Pc(e, t, n, r, o, a) {
          ...
          if (((r = e), 'function' == typeof e)) jc(e) && (s = 1);
            ...
            e: switch (e) {
              ...
              case M:
                return (
                  ((e = Nc(12, n, t, 2 | o)).elementType = M), (e.lanes = a), e
                );
              case I:
                return (
                  ((e = Nc(13, n, t, o)).elementType = I), (e.lanes = a), e
                );
              case R:
                return (
                  ((e = Nc(19, n, t, o)).elementType = R), (e.lanes = a), e
                );
              case j:
                return Bc(n, o, a, t);
              default:
        ...
        function Vc(e, t, n, r, o, i, a, s, l) {
          return (
            ...
            (n = e.current),
            ((i = Li((r = tc()), (o = nc(n)))).callback = null != t ? t : null),
            Pi(n, i, o),
            (e.current.lanes = o),
            vt(e, o, r),
            oc(e, r),
        ...
        function Wc(e, t, n, r) {
          ...
          return (
            ...
            null !== (e = Pi(o, t, a)) && (rc(e, o, a, i), zi(e, o, a)),
            a
          );
        }
        function Yc(e) {
        ...
        wl = function (e, t, n) {
          if (null !== e)
            if (e.memoizedProps !== t.pendingProps || Ro.current) As = !0;
            else {
                  ...
                  (function (e, t, n) {
                    switch (t.tag) {
                      ...
                      case 10:
                        ...
                        ko(yi, r._currentValue), (r._currentValue = o);
                        break;
                      case 13:
          ...
          switch (((t.lanes = 0), t.tag)) {
            ...
            case 1:
              return (
                (r = t.type),
                (o = t.pendingProps),
                Ts(e, t, r, (o = t.elementType === r ? o : vi(r, o)), n)
              );
            case 3:
              e: {
                ...
                if (((r = s.element), a.isDehydrated)) {
                  if (
                    ...
                    t = Os(e, t, r, n, (o = us(Error(i(423)), t)));
                    break e;
                  }
                  if (r !== o) {
                    t = Os(e, t, r, n, (o = us(Error(i(424)), t)));
                    break e;
                  }
                  for (
            ...
            case 11:
              return (
                (r = t.type),
                (o = t.pendingProps),
                xs(e, t, r, (o = t.elementType === r ? o : vi(r, o)), n)
              );
            case 7:
        ...
        (Xc.prototype.render = Zc.prototype.render =
          function (e) {
            var t = this._internalRoot;
            if (null === t) throw Error(i(409));
            Wc(e, t, null, null);
          }),
          (Xc.prototype.unmount = Zc.prototype.unmount =
            function () {
      ...
      287: (e, t) => {
        ...
        function M(e, t, r) {
          ...
          if (null != t)
            ...
            t))
              x.call(t, o) && !w.hasOwnProperty(o) && (i[o] = t[o]);
            ...
            return (
              ...
              i > a
                ? ((e.sortIndex = i),
                  ...
                  null === r(c) &&
                    e === r(u) &&
                    (g ? (y(S), (S = -1)) : (g = !0), L(C, i - a)))
                : ((e.sortIndex = s), n(c, e), m || h || ((m = !0), j(x))),
              e
            );
          }),
        ...
        function r(e, r) {
          for (var i = {}, a = [], s = 0; s < e.length; s++) {
            ...
            if (-1 !== d) t[d].references++, t[d].updater(f);
              ...
              var h = o(f, r);
              (r.byIndex = s),
                t.splice(s, 0, { identifier: p, updater: h, references: 1 });
            }
            a.push(p);
          }
          return a;
    ...
    (() => {
      ...
      function a(e) {
        const t = (function (e) {
            ...
            t.setAttribute('id', 'aframeInspectorMouseCursor'),
              t.setAttribute('raycaster', {
                interval: 100,
                objects: 'a-scene :not([data-aframe-inspector])'
              }),
              t.setAttribute('cursor', 'rayOrigin', 'mouse'),
              t.setAttribute('data-aframe-inspector', 'true');
            const n = t.components.raycaster,
              o = n.refreshObjects;
            (n.refreshObjects = () => {
              o.call(n);
              const e = n.objects;
              n.objects = e.filter((e) => {
                for (; e; ) {
              ...
              t.addEventListener('mouseenter', function () {
                r.emit(
                  'raycastermouseenter',
                  t.components.cursor.intersectedEl
                );
              }),
              ...
              e.sceneEl.canvas.addEventListener('mouseleave', () => {
                setTimeout(() => {
                  r.emit('raycastermouseleave', null);
                });
              });
            ...
            function l(t) {
              ...
              t.preventDefault();
              const n = i(e.container, t.clientX, t.clientY);
              a.fromArray(n);
            }
            function c(t) {
              if (t instanceof CustomEvent) return;
            ...
            function u(e) {
              const n = t.components.cursor.intersectedEl;
              n && r.emit('objectfocus', n.object3D);
            }
            return {
              el: t,
              enable: () => {
                t.setAttribute('raycaster', 'enabled', !0),
                  e.container.addEventListener('mousedown', l),
                  e.container.addEventListener('mouseup', c),
                  e.container.addEventListener('dblclick', u);
              },
              disable: () => {
                t.setAttribute('raycaster', 'enabled', !1),
        ...
        (u.size = 0.75),
          u.addEventListener('objectChange', (t) => {
            const n = u.object;
            if (void 0 === n) return;
            let r, o;
            if ((s.setFromObject(n), l(n), 'translate' === t.mode))
              (r = 'position'),
                (o = `${n.position.x} ${n.position.y} ${n.position.z}`);
            else if ('rotate' === t.mode) {
              r = 'rotation';
              const e = THREE.MathUtils.radToDeg;
              o = `${e(n.rotation.x)} ${e(n.rotation.y)} ${e(n.rotation.z)}`;
            } else
              'scale' === t.mode &&
                ((r = 'scale'), (o = `${n.scale.x} ${n.scale.y} ${n.scale.z}`));
            e.execute('entityupdate', {
              component: r,
              entity: u.object.el,
              value: o
            });
          ...
          o.add(u),
          r.on('entityupdate', (t) => {
            const n = t.entity.object3D;
            e.selected === n &&
              e.selectedEntity.object3DMap.mesh &&
              s.setFromObject(e.selected);
          });
        const p = new THREE.EditorControls(c, e.container);
        function d() {
          t.enable(), u.activate(), (p.enabled = !0);
        }
        function f() {
          if (!e.opened) return;
          const t = e.camera,
          ...
          const r = e.helpers[t.uuid];
          r && r.update();
        }
        p.center.set(0, 1.6, 0),
          (p.rotationSpeed = 0.0035),
          (p.zoomSpeed = 0.05),
          p.setAspectRatio(n.canvas.width / n.canvas.height),
          p.addEventListener('change', () => {
            u.update(!0), r.emit('camerachanged');
          }),
          r.on('cameratoggle', (e) => {
            p.setCamera(e.camera), u.setCamera(e.camera), f();
          }),
          d(),
          r.on('inspectorcleared', () => {
            p.center.set(0, 0, 0);
          }),
          r.on('transformmodechange', (e) => {
            u.setMode(e);
          }),
          r.on('translationsnapchanged', (e) => {
            u.setTranslationSnap(e);
          }),
          r.on('rotationsnapchanged', (e) => {
            u.setRotationSnap(e);
          }),
          r.on('transformspacechanged', (e) => {
            u.setSpace(e);
          }),
          r.on('objectselect', (e) => {
            if (((s.visible = !1), u.detach(), e && e.el)) {
              if (e.el.getObject3D('mesh'))
                s.setFromObject(e), (s.visible = !0);
              else if (e.el.hasAttribute('gltf-model')) {
                const t = (n) => {
                  n.target === e.el &&
                    (s.setFromObject(e),
                    (s.visible = !0),
                ...
                e.el.addEventListener('model-loaded', t);
              }
              u.attach(e);
            }
          }),
          ...
          e.sceneEl.addEventListener('rendererresize', f),
          r.on('gridvisibilitychanged', (e) => {
            a.visible = e;
          }),
          r.on('togglegrid', () => {
            a.visible = !a.visible;
          }),
          r.on('inspectortoggle', (n) => {
            n
              ? (d(),
      ...
      l.prototype = {
        load: function () {
          var e = new XMLHttpRequest(),
            t = s + 'dist/images.json';
          e.open('GET', t),
            (e.onload = () => {
              var t = JSON.parse(e.responseText);
              (this.images = t.images),
                this.images.forEach((e) => {
                  (e.fullPath = s + t.basepath.images + e.path),
                    (e.fullThumbPath =
                      s + t.basepath.images_thumbnails + e.thumbnail);
                }),
      ...
      function h(e, t) {
        e &&
          ...
          AFRAME.INSPECTOR.execute('entityremove', e);
      }
      function m(e) {
        return AFRAME.INSPECTOR.execute('entityclone', e);
      }
      function g(e) {
        var t = v(e).outerHTML;
        return (
        ...
        for (
          ...
          (i.nodeType === Node.ELEMENT_NODE &&
            (i.hasAttribute('aframe-injected') ||
              ...
              i.classList.contains('teleportRay') ||
              i.classList.contains('hitEntity') ||
              i.parentElement.hasAttribute('environment'))) ||
            t.appendChild(v(n[r]));
        }
        return (
          (function (e, t) {
            var n,
              r = HTMLElement.prototype.removeAttribute,
              o = HTMLElement.prototype.setAttribute,
              i = t.components || {};
            Object.keys(i).forEach(function (a) {
              if (n && n.has(a)) r.call(e, a);
              else {
                var s = i[a],
                  l = (function (e, t) {
                    var n = !1,
                      r = (
                        w(e.schema)
                          ? function () {
                              var r = C(e, null, t);
                              return (
                                void 0 === r && (r = x(e, null, t)),
                                void 0 !== r ? (n = !0) : (r = E(e, null)),
                                void 0 !== r ? e.schema.parse(r) : r
                              );
                            }
                          : function () {
                              var r,
                                o = t.defaultComponentsFromPrimitive;
                              return (
                                (n =
                                  o &&
                                  o.hasOwnProperty(e.attrName) &&
                                  0 === Object.keys(o[e.attrName]).length),
                  ...
                  p = (function (e, t, n, r) {
                    ...
                    if (
                      ...
                      for (o in i) void 0 === i[o] && delete i[o];
                    return i;
                  })(s, l[0], t.getAttribute(a), t.getDOMAttribute(a));
                if (c && null === p) r.call(e, a);
                else {
                  var d =
                    ((f = s.schema),
                    null === (h = void 0 === (h = p) ? {} : h)
                      ...
                      : (w(f)
                          ? function () {
                              return f.stringify(h);
                            }
                          : function () {
                              var e = {};
                              return (
                                Object.keys(h).forEach(function (t) {
                                  f[t] && (e[t] = f[t].stringify(h[t]));
                                }),
                                AFRAME.utils.styleParser.stringify(e)
                              );
                            })());
                  'geometry' !== a ||
                    d.includes('primitive') ||
                    (d = '' === d ? 'primitive: box' : 'primitive: box; ' + d),
                    'light' !== a ||
                      d.includes('type') ||
                      (d =
                        '' === d
                ...
                '' !== d ||
                  ...
                  'A-SCENE' === e.tagName &&
                    ('fog' === a &&
                      ...
                      r.call(e, a),
                    'keyboard-shortcuts' === a && '' === d && r.call(e, a),
                    'screenshot' === a && '' === d && r.call(e, a),
                    'vr-mode-ui' === a && '' === d && r.call(e, a),
                    'xr-mode-ui' === a && '' === d && r.call(e, a),
                    'device-orientation-permission-ui' === a &&
                      '' === d &&
                      r.call(e, a)),
                  'laser-controls' === a
                    ? (n = y)
      ...
      function C(e, t, n) {
        for (
          var r, o = n.mixinEls.toReversed(), i = 0;
          void 0 === r && i < o.length;
          i++
        ) {
          var a = o[i];
          a.attributes.hasOwnProperty(e.attrName) &&
            (r = t
              ? a.getAttribute(e.attrName)[t]
              : a.getAttribute(e.attrName));
        }
        return r;
      }
      function x(e, t, n) {
        var r,
          o = n.defaultComponentsFromPrimitive;
        return (
          o &&
            o.hasOwnProperty(e.attrName) &&
            (r = t ? o[e.attrName][t] : o[e.attrName]),
          r
        );
      }
      function E(e, t, n) {
      ...
      const I = {
        ...
        onKeyUp: function (e) {
          if (T(e) && AFRAME.INSPECTOR.opened) {
            var t = e.keyCode;
            if (
              (72 === t && r.emit('openhelpmodal'),
              27 === t &&
                this.inspector.selectedEntity &&
                this.inspector.selectEntity(null),
              87 === t && r.emit('transformmodechange', 'translate'),
              69 === t && r.emit('transformmodechange', 'rotate'),
              82 === t && r.emit('transformmodechange', 'scale'),
              79 === t && r.emit('transformspacechange'),
              71 === t && r.emit('togglegrid'),
              78 === t &&
              ...
              (8 !== t && 46 !== t) ||
                (AFRAME.INSPECTOR.selectedEntity &&
                  h(AFRAME.INSPECTOR.selectedEntity, undefined)),
              68 === t &&
                AFRAME.INSPECTOR.selectedEntity &&
                m(AFRAME.INSPECTOR.selectedEntity),
              70 === t)
            ) {
              const e = AFRAME.INSPECTOR.selectedEntity;
              null != e && r.emit('objectfocus', e.object3D);
            }
            for (var n in (49 === t
              ? r.emit('cameraperspectivetoggle')
              : 50 === t
                ? r.emit('cameraorthographictoggle', 'left')
                : 51 === t
                  ? r.emit('cameraorthographictoggle', 'right')
                  : 52 === t
                    ? r.emit('cameraorthographictoggle', 'top')
                    : 53 === t
                      ? r.emit('cameraorthographictoggle', 'bottom')
                      : 54 === t
                        ? r.emit('cameraorthographictoggle', 'back')
                        : 55 === t &&
                          r.emit('cameraorthographictoggle', 'front'),
            this.shortcuts.modules)) {
              var o = this.shortcuts.modules[n];
              o[t] &&
                (!o[t].mustBeActive ||
                  (o[t].mustBeActive && AFRAME.INSPECTOR.modules[n].active)) &&
                this.shortcuts.modules[n][t].callback();
            }
          }
        },
        onKeyDown: function (e) {
          T(e) &&
            ...
            (((e.ctrlKey && 'macos' !== k) || (e.metaKey && 'macos' === k)) &&
              (90 === e.keyCode &&
                (e.preventDefault(),
                e.stopPropagation(),
                e.shiftKey ? AFRAME.INSPECTOR.redo() : AFRAME.INSPECTOR.undo()),
              AFRAME.INSPECTOR.selectedEntity &&
                'INPUT' !== document.activeElement.tagName &&
                (67 === e.keyCode &&
                  (AFRAME.INSPECTOR.entityToCopy =
                    AFRAME.INSPECTOR.selectedEntity),
                86 === e.keyCode && m(AFRAME.INSPECTOR.entityToCopy)),
              83 === e.keyCode &&
                (e.preventDefault(),
                e.stopPropagation(),
                document.getElementById('filter').focus())),
            48 === e.keyCode &&
              (r.emit('togglesidebar', { which: 'all' }),
              e.preventDefault(),
              e.stopPropagation()));
        },
        enable: function () {
        ...
        registerModuleShortcut: function (e, t, n, r) {
          this.checkModuleShortcutCollision(e, n, r) ||
            ...
            !1 !== r && (r = !0),
            (this.shortcuts.modules[n][e] = { callback: t, mustBeActive: r }));
        },
        init: function (e) {
          (this.inspector = e),
      ...
      O.set(
        ...
        class extends R {
          ...
          execute(e) {
            const t = document.querySelector(`#${this.entityId}:not(a-mixin)`);
            t &&
              (t.setAttribute(this.component, this.value),
              r.emit('componentadd', {
                entity: t,
          ...
          undo(e) {
            const t = document.querySelector(`#${this.entityId}:not(a-mixin)`);
            t &&
              (t.removeAttribute(this.component),
              r.emit('componentremove', {
                entity: t,
                component: this.component
              }),
              e?.(t));
          ...
          class extends R {
            constructor(e, t) {
              ...
              n.id || (n.id = M()),
                ...
                (this.component = t.component);
              const r =
                n.components[t.component] ?? AFRAME.components[t.component];
              this.value = r.isSingleProperty
                ? r.schema.stringify(n.getAttribute(t.component))
                : structuredClone(n.getDOMAttribute(t.component));
            }
            execute(e) {
              const t = document.querySelector(
                `#${this.entityId}:not(a-mixin)`
              );
              t &&
                (t.removeAttribute(this.component),
                r.emit('componentremove', {
                  ...
                  return (
                    ...
                    t
                      ...
                      : e.id
                        ...
                        : (e.id = M()),
                    (o = n),
                    (i = e).parentNode || (i = AFRAME.INSPECTOR.selectedEntity),
                    i
                      ? i.parentNode.insertBefore(o, i.nextSibling)
                      : AFRAME.INSPECTOR.sceneEl.appendChild(o),
                    n
                  );
                })(t, this.entityId);
                return (this.entityId = n.id), e?.(n), n;
              }
            }
            undo(e) {
              const t = document.querySelector(
              ...
              if (t) {
                t.parentNode.removeChild(t), r.emit('entityremoved', t);
                const n = document.querySelector(
                  `#${this.entityIdToClone}:not(a-mixin)`
                );
                this.editor.selectEntity(n), e?.(t);
              }
            }
          }
        ),
          ...
          class extends R {
            ...
            execute(e) {
              ...
              this.definition.parentEl &&
                (t =
                  'string' == typeof this.definition.parentEl
                    ? document.getElementById(this.definition.parentEl)
                    : this.definition.parentEl),
                t ||
                  (t = document.querySelector(
                    this.editor.config.defaultParent
                  )),
                this.entityId &&
                  (n = { ...this.definition, id: this.entityId });
              const o = (function (e, t, n) {
                const o = document.createElement(e.element || 'a-entity');
                e.id ? (o.id = e.id) : (o.id = M());
                for (const t of S)
                  'id' !== t && e[t] && o.setAttribute(t, e[t]);
                for (const t in e)
                  t.startsWith('data-') && o.setAttribute(t, e[t]);
                ...
                n,
                (t) => {
                  this.editor.selectEntity(t), this.callback?.(t), e?.(t);
                },
                t
              );
              return (this.entityId = o.id), o;
            }
            undo(e) {
              const t = document.querySelector(
                `#${this.entityId}:not(a-mixin)`
          ...
          class extends R {
            constructor(e, t) {
              super(e),
                ...
                (this.updatable = !1),
                (this.entity = t),
                (this.parentEl = t.parentNode),
                (this.index = Array.from(this.parentEl.children).indexOf(t));
            }
            execute(e) {
              const t = (function (e) {
                for (
              ...
              const n = v(this.entity);
              this.entity.parentNode.removeChild(this.entity),
                r.emit('entityremoved', this.entity),
                (this.entity = n),
                this.editor.selectEntity(t),
                e?.(null);
            }
            undo(e) {
              const t = this.parentEl.children[this.index] ?? null;
              this.parentEl.insertBefore(this.entity, t),
                this.entity.addEventListener(
                  'loaded',
                  () => {
                    r.emit('entitycreated', this.entity),
          ...
          class extends R {
            constructor(e, t) {
              ...
              r
                ? t.property
                  ? (r.schema[t.property]
                      ? ((this.newValue = r.schema[t.property].stringify(
                          t.value
                        )),
                        (this.oldValue = r.schema[t.property].stringify(
                          t.entity.getAttribute(t.component)[t.property]
                        )))
                      : ((this.newValue = t.value),
                        (this.oldValue = t.entity.getAttribute(t.component)[
                          t.property
                        ])),
                    this.editor.config.debugUndoRedo &&
                      console.log(
                  ...
                  : ((this.newValue = r.isSingleProperty
                      ? r.schema.stringify(t.value)
                      : t.value),
                    (this.oldValue = r.isSingleProperty
                      ? r.schema.stringify(t.entity.getAttribute(t.component))
                      : structuredClone(t.entity.getDOMAttribute(t.component))),
                    this.editor.config.debugUndoRedo &&
                      console.log(
                ...
                : ((this.newValue = t.value),
                  (this.oldValue = t.entity.getAttribute(this.component)),
                  this.editor.config.debugUndoRedo &&
                    console.log(
            ...
            execute(e) {
              ...
              t &&
                ...
                f(t, this.component, this.property, this.newValue),
                'id' === this.component && (this.entityId = this.newValue),
                e?.(t));
            }
            undo(e) {
              const t = document.querySelector(
              ...
              t &&
                ...
                f(t, this.component, this.property, this.oldValue),
                'id' === this.component && (this.entityId = this.oldValue),
                e?.(t));
            }
            update(e) {
              this.editor.config.debugUndoRedo && console.log('update', e),
              ...
              super(e),
                ...
                (this.commands = t
                  .map((t) => {
                    ...
                    return n
                      ? new n(e, t[1], t[2])
                      : (console.error(`Command ${t[0]} not found`), null);
                  })
                  .filter(Boolean));
            }
            execute() {
              return this.commands
                .toReversed()
                .reduce((e, t) => (n) => t.execute(e), this.callback)();
            }
            undo() {
      ...
      class J extends N.Component {
        static propTypes = { icon: q().object.isRequired };
        render() {
          const {
            width: e,
            height: t,
            ...
            return (
              (o = Array.isArray(r)
                ? (0, K.jsx)('g', {
                    children: r.map((e, t) =>
                      (0, K.jsx)('path', { fill: 'currentColor', d: e }, t)
                    )
                  })
                : (0, K.jsx)('path', { fill: 'currentColor', d: r })),
              { width: t, height: n, icon: o }
            );
      ...
      function He(e) {
        return (Te = Ie = 1), (Re = Me((je = e))), (Oe = 0), [];
      }
      function Ve(e) {
        return (je = ''), e;
      }
      function We(e) {
        return Ae(_e(Oe - 1, $e(91 === e ? e + 2 : 40 === e ? e + 1 : e)));
      }
      function Ye(e) {
        for (; (Ne = De()) && Ne < 33; ) Be();
      ...
      function Qe(e, t) {
        ...
        return _e(e, Fe() + (t < 6 && 32 == De() && 32 == Be()));
      }
      function $e(e) {
        for (; Be(); )
          switch (Ne) {
      ...
      function Ge(e, t) {
        for (; Be() && e + Ne !== 57 && (e + Ne !== 84 || 47 !== De()); );
        return '/*' + _e(t, Oe - 1) + '*' + ye(47 === e ? e : Be());
      }
      function Ze(e) {
        for (; !Ue(De()); ) Be();
        return _e(e, Oe);
      ...
      function ot(e, t, n, r) {
        ...
        return Me((n = rt(e.children, r)))
          ? (e.return = e.value + '{' + n + '}')
          : '';
      }
      function it(e) {
        return Ve(at('', null, null, null, [''], (e = He(e)), 0, [0], e));
      }
      function at(e, t, n, r, o, i, a, s, l) {
        for (
          var c = 0,
            u = 0,
            p = a,
          ...
          switch (((h = y), (y = Be()))) {
            case 40:
              if (108 != h && 58 == Ee(E, p - 1)) {
                -1 != xe((E += Ce(We(y), '&', '&\f')), '&\f') && (v = -1);
                break;
              }
            case 34:
            case 39:
            ...
            case 0:
              switch (y) {
                ...
                default:
                  if (
                    (ke(
                      (x = st(E, t, n, c, u, o, s, b, (A = []), (C = []), p)),
                      i
                    ),
                    123 === y)
                  )
                    if (0 === u) at(E, t, x, x, A, i, p, s, C);
                    else
                      switch (99 === d && 110 === Ee(E, 3) ? 100 : d) {
                        case 100:
                        case 109:
                        case 115:
                          at(
            ...
            default:
              if (m < 1)
                if (123 == y) --m;
                else if (125 == y && 0 == m++ && 125 == ze()) continue;
              switch (((E += ye(y)), y * m)) {
                case 38:
                  v = u > 0 ? 1 : ((E += '\f'), -1);
                  break;
      ...
      function st(e, t, n, r, o, i, a, s, l, c, u) {
        for (
          var p = o - 1, d = 0 === o ? i : [''], f = Se(d), h = 0, m = 0, g = 0;
          h < r;
          ++h
        )
          for (
            var v = 0, y = we(e, p + 1, (p = ve((m = a[h])))), b = e;
            v < f;
            ++v
          )
            (b = Ae(m > 0 ? d[v] + ' ' + y : Ce(y, /&\f/g, d[v]))) &&
              (l[g++] = b);
        return Le(e, t, n, 0 === o ? et : s, l, c, u);
      }
      function lt(e, t, n) {
        return Le(e, t, n, Je, ye(Ne), we(e, 2, -2), 0);
      }
      function ct(e, t, n, r) {
        return Le(e, t, n, tt, we(e, 0, r), we(e, r + 1, -1), r);
      }
      var ut = function (e, t, n) {
          for (
            var r = 0, o = 0;
            (r = o), (o = De()), 38 === r && 12 === o && (t[n] = 1), !Ue(o);
        ...
        dt = function (e) {
          if ('rule' === e.type && e.parent && !(e.length < 1)) {
            ...
            if (
              (1 !== e.props.length || 58 === t.charCodeAt(0) || pt.get(n)) &&
              !r
            ) {
              pt.set(e, !0);
              for (
      ...
      function ht(e, t) {
        switch (
          ...
          case 6968:
          case 2756:
            return Ke + e + qe + e + Xe + e + e;
          case 6828:
          case 4268:
            return Ke + e + Xe + e + e;
          case 6165:
            return Ke + e + Xe + 'flex-' + e + e;
          case 5187:
            return (
              Ke +
              e +
              Ce(e, /(\w+).+(:[^]+)/, Ke + 'box-$1$2' + Xe + 'flex-$1$2') +
              e
            );
          case 5443:
            return Ke + e + Xe + 'flex-item-' + Ce(e, /flex-|-self/, '') + e;
          case 4675:
            return (
              Ke +
              e +
          ...
          case 5548:
            return Ke + e + Xe + Ce(e, 'shrink', 'negative') + e;
          case 5292:
            return Ke + e + Xe + Ce(e, 'basis', 'preferred-size') + e;
          case 6060:
            return (
              Ke +
              'box-' +
          ...
          case 6187:
            return (
              Ce(
                Ce(Ce(e, /(zoom-|grab)/, Ke + '$1'), /(image-set)/, Ke + '$1'),
                e,
                ''
              ) + e
            );
          ...
          case 4765:
            if (Me(e) - 1 - t > 6)
              switch (Ee(e, t + 1)) {
                ...
                case 115:
                  return ~xe(e, 'stretch')
                    ? ht(Ce(e, 'stretch', 'fill-available'), t) + e
                    : e;
              }
            break;
          case 4949:
          ...
          case 6444:
            switch (Ee(e, Me(e) - 3 - (~xe(e, '!important') && 10))) {
              case 107:
                return Ce(e, ':', ':' + Ke) + e;
              case 101:
                return (
          ...
          case 5936:
            switch (Ee(e, t + 11)) {
              case 114:
                return Ke + e + Xe + Ce(e, /[svh]\w+-[tblr]{2}/, 'tb') + e;
              case 108:
                return Ke + e + Xe + Ce(e, /[svh]\w+-[tblr]{2}/, 'tb-rl') + e;
              case 45:
                return Ke + e + Xe + Ce(e, /[svh]\w+-[tblr]{2}/, 'lr') + e;
            }
            return Ke + e + Xe + e + e;
        }
        return e;
          ...
          if (e.length > -1 && !e.return)
            switch (e.type) {
              case tt:
                ...
                break;
              case nt:
                return rt([Pe(e, { value: Ce(e.value, '@', '@' + Ke) })], r);
              case et:
                if (e.length)
                  return (function (e, t) {
                    return e.map(t).join('');
                      ...
                      case '::placeholder':
                        return rt(
                          [
                            Pe(e, {
                              props: [
                                Ce(t, /:(plac\w+)/, ':' + Ke + 'input-$1')
                              ]
                            }),
                            Pe(e, { props: [Ce(t, /:(plac\w+)/, ':-moz-$1')] }),
                            Pe(e, {
                              props: [Ce(t, /:(plac\w+)/, Xe + 'input-$1')]
                            })
                          ],
                          r
                        );
      ...
      var At = /[A-Z]|^ms/g,
        ...
        wt = (function (e) {
          ...
          return function (e) {
            return (
              void 0 === t[e] &&
                (t[e] = xt((n = e)) ? n : n.replace(At, '-$&').toLowerCase()),
              t[e]
            );
            var n;
          };
        ...
        Mt = function (e, t) {
          switch (e) {
            ...
            case 'animationName':
              if ('string' == typeof t)
                return t.replace(Ct, function (e, t, n) {
                  return (kt = { name: t, styles: n, next: kt }), t;
                });
          }
          return 1 === bt[e] || xt(e) || 'number' != typeof t || 0 === t
            ? t
            : t + 'px';
        };
      function St(e, t, n) {
        ...
        switch (typeof n) {
          ...
          case 'object':
            ...
            return (function (e, t, n) {
              var r = '';
              if (Array.isArray(n))
                for (var o = 0; o < n.length; o++) r += St(e, t, n[o]) + ';';
              else
                for (var i in n) {
                  var a = n[i];
                  if ('object' != typeof a)
      ...
      var kt,
        ...
        It = function (e, t, n) {
          ...
          for (var a = 1; a < e.length; a++)
            (o += St(n, t, e[a])), r && (o += i[a]);
          Tt.lastIndex = 0;
          for (var s, l = ''; null !== (s = Tt.exec(o)); ) l += '-' + s[1];
          return { name: yt(o) + l, styles: o, next: kt };
        },
        Rt =
          (!!j.useInsertionEffect && j.useInsertionEffect) ||
          function (e) {
            return e();
          },
        Ot = {}.hasOwnProperty,
        Nt = (0, N.createContext)(
          'undefined' != typeof HTMLElement ? gt({ key: 'css' }) : null
        );
      Nt.Provider;
      var jt = function (e) {
          return (0, N.forwardRef)(function (t, n) {
            var r = (0, N.useContext)(Nt);
            return e(t, r, n);
          });
        },
        ...
        Bt = jt(function (e, t, n) {
          ...
          var s = It(i, void 0, (0, N.useContext)(Lt));
          a += t.key + '-' + s.name;
          var l = {};
          for (var c in e)
            Ot.call(e, c) && 'css' !== c && c !== Pt && (l[c] = e[c]);
          return (
            (l.ref = n),
            (l.className = a),
            (0, N.createElement)(
              N.Fragment,
              null,
              (0, N.createElement)(zt, {
                cache: t,
                serialized: s,
                isStringTag: 'string' == typeof o
              }),
              (0, N.createElement)(o, l)
            )
          );
        });
      o(146);
      ...
      function Jt(e) {
        const t =
          !Qt(e) && e.contextElement ? e.contextElement : Qt(e) ? e : null;
        if (!t) return Kt;
        ...
        if ('border-box' !== r.boxSizing)
          return Yt(t)
            ? {
                x: (t.offsetWidth > 0 && qt(n.width) / t.offsetWidth) || 1,
                y: (t.offsetHeight > 0 && qt(n.height) / t.offsetHeight) || 1
              }
            : Kt;
      ...
      function en(e, t, n, r) {
        ...
        let c = Kt;
        t && (r ? Qt(r) && (c = Jt(r)) : (c = Jt(e)));
        const u = Qt(e) ? Ut(e) : window,
          p = !Xt() && n,
          d =
            (l.left +
              (p &&
      ...
      function rn(e, t) {
        ...
        const r = nn(e),
          ...
          i = Ut(r);
        return o
          ? t.concat(i, i.visualViewport || [], Zt(r) ? r : [])
          : t.concat(r, rn(r));
      }
      const on = N.useLayoutEffect;
      var an = [
          'className',
          'clearValue',
          'cx',
      ...
      function cn(e, t) {
        ...
        if (t && e)
          for (var a in t)
            t.hasOwnProperty(a) && t[a] && i.push(''.concat(ln(e, a)));
        return i
          .filter(function (e) {
            return e;
          })
      ...
      function gn(e, t) {
        var n =
            arguments.length > 2 && void 0 !== arguments[2]
              ...
              : 200,
          r =
            arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : sn,
          o = hn(e),
          i = t - o,
          a = 0;
        !(function t() {
          ...
          mn(e, l), a < n ? window.requestAnimationFrame(t) : r(e);
        })();
      }
      function vn(e, t) {
        ...
        r.bottom + o > n.bottom
          ...
          : r.top - o < n.top && mn(e, Math.max(t.offsetTop - o, 0));
      }
      function yn() {
        try {
      ...
      Cn.addEventListener &&
        ...
        (Cn.addEventListener('p', sn, An), Cn.removeEventListener('p', sn, !1));
      var xn = bn;
      function En(e) {
        return null != e;
      }
      ...
      var kn,
        ...
        Nn = function (e) {
          var t = e.children,
            ...
            s = e.theme,
            l = ((0, N.useContext)(On) || {}).setPortalPlacement,
            c = (0, N.useRef)(null),
            u = se((0, N.useState)(r), 2),
            p = u[0],
            d = u[1],
            f = se((0, N.useState)(null), 2),
            h = f[0],
            m = f[1],
            ...
            on(
              function () {
                ...
                if (e) {
                  ...
                  d(s.maxHeight), m(s.placement), null == l || l(s.placement);
                }
              },
              [r, o, i, a, n, l, g]
            ),
        ...
        Yn = (function () {
          ...
          kn ||
            ...
            In || (In = Tn.slice(0)),
            (kn = Object.freeze(
              Object.defineProperties(Tn, { raw: { value: Object.freeze(In) } })
            )))
        ),
        Qn = function (e) {
          var t = e.delay,
        ...
        $n = ['data'],
        Gn = ['innerRef', 'isDisabled', 'isHidden', 'inputClassName'],
        Zn = {
          gridArea: '1 / 2',
          font: 'inherit',
          minWidth: '2px',
        ...
        Jn = {
          ...
          GroupHeading: function (e) {
            ...
            return Dt(
              'div',
              ue({}, dn(e, 'groupHeading', { 'group-heading': !0 }), n)
            );
          },
          IndicatorsContainer: function (e) {
            ...
            return Dt(
              'div',
              ue({}, dn(e, 'indicatorsContainer', { indicators: !0 }), n),
              t
            );
          },
          ...
          Input: function (e) {
            ...
            return Dt(
              'div',
              ue({}, dn(e, 'input', { 'input-container': !0 }), {
                'data-value': n || ''
              }),
              Dt(
                'input',
          ...
          LoadingIndicator: function (e) {
            ...
            return Dt(
              ...
              ue(
                {},
                dn(
                  oe(oe({}, i), {}, { innerProps: t, isRtl: n, size: o }),
                  'loadingIndicator',
                  { indicator: !0, 'loading-indicator': !0 }
                ),
                t
              ),
              Dt(Qn, { delay: 0, offset: n }),
              Dt(Qn, { delay: 160, offset: !0 }),
              Dt(Qn, { delay: 320, offset: !n })
            );
          },
          Menu: function (e) {
            var t = e.children,
          ...
          MenuPortal: function (e) {
                ...
                function () {
                  if (r) {
                    var e = (function (e) {
                      ...
                      n = e[u] + t;
                    (n === (null == h ? void 0 : h.offset) &&
                      e.left === (null == h ? void 0 : h.rect.left) &&
                      e.width === (null == h ? void 0 : h.rect.width)) ||
                      m({ offset: n, rect: e });
                  }
                },
                [
            ...
            var y = (0, N.useCallback)(
              function (e) {
                (s.current = e), v();
              },
              [v]
            );
            if ((!t && 'fixed' !== a) || !h) return null;
            var b = Dt(
              'div',
              ue(
                { ref: y },
                dn(
                  oe(
                    oe({}, e),
                    {},
                    { offset: h.offset, position: a, rect: h.rect }
                  ),
                  'menuPortal',
                  { 'menu-portal': !0 }
                ),
          ...
          LoadingMessage: function (e) {
            ...
            return Dt(
              ...
              ue(
                {},
                dn(
                  oe(oe({}, o), {}, { children: n, innerProps: r }),
                  'loadingMessage',
          ...
          Placeholder: function (e) {
            ...
            return Dt(
              'div',
              ue({}, dn(e, 'placeholder', { placeholder: !0 }), n),
              t
            );
          },
      ...
      function tr(e, t) {
        ...
        for (var n = 0; n < e.length; n++)
          if (!((r = e[n]) === (o = t[n]) || (er(r) && er(o)))) return !1;
        var r, o;
        return !0;
      }
      for (
          ...
          ir = function (e) {
            var t = e.ariaSelection,
                ...
                function () {
                  ...
                  if (t && E.onChange) {
                    var r = t.option,
                      ...
                      f = d ? d.map(p) : [],
                      m = oe(
                        { isDisabled: c && h(c, a), label: u, labels: f },
                        t
                      );
                    n = E.onChange(m);
                  }
              ...
              T = (0, N.useMemo)(
                ...
                [C, n, r, f, h, m, g, E, a, b, k]
              ),
              I = Dt(
                N.Fragment,
                null,
                Dt('span', { id: 'aria-selection' }, w),
                Dt('span', { id: 'aria-focused' }, M),
                Dt('span', { id: 'aria-results' }, S),
                Dt('span', { id: 'aria-guidance' }, T)
              );
            return Dt(
              N.Fragment,
              null,
        ...
        for (var ur = ar[cr], pr = 0; pr < ur.letters.length; pr++)
          lr[ur.letters[pr]] = ur.base;
      var dr = function (e) {
      ...
      function vr(e) {
        var t = e.innerRef,
          ...
          })(le(e, gr), 'onExited', 'in', 'enter', 'exit', 'appear');
        return Dt(
          'input',
          ue({ ref: t }, n, {
            css: Ft(
      ...
      var yr = ['boxSizing', 'height', 'overflow', 'paddingRight', 'position'],
        br = {
              ...
              a = (0, N.useCallback)(
                function (e) {
                  if (wr) {
                    ...
                    t &&
                      Er() &&
                      (t.addEventListener('touchmove', Ar, Sr),
                      e &&
                        (e.addEventListener('touchstart', xr, Sr),
                        e.addEventListener('touchmove', Cr, Sr))),
                      (Mr += 1);
                  }
                },
                [r]
                ...
                function (e) {
                  if (wr) {
                    ...
                    (Mr = Math.max(Mr - 1, 0)),
                      ...
                      t &&
                        Er() &&
                        (t.removeEventListener('touchmove', Ar, Sr),
                        e &&
                          (e.removeEventListener('touchstart', xr, Sr),
                          e.removeEventListener('touchmove', Cr, Sr)));
                  }
                },
                [r]
              );
      ...
      function Ur(e, t) {
        var n = e.inputValue,
          ...
          a = t.label,
          s = t.value;
        return (!Gr(e) || !i) && $r(e, { label: a, value: s, data: o }, r);
      }
      var Hr = function (e, t) {
          var n;
          return (
            ...
            if (
              ...
              (r.selectOption = function (e) {
                ...
                if (s) {
                  ...
                  o
                    ? r.setValue([].concat(me(a), [e]), 'select-option', e)
              ...
              (r.clearValue = function () {
                ...
                r.onChange(wn(r.props.isMulti, [], null), {
                  action: 'clear',
                  removedValues: e
                });
              }),
              ...
              (r.getFocusedOptionId = function (e) {
                return Hr(r.state.focusableOptionsWithIds, e);
              }),
              (r.getFocusableOptionsWithIds = function () {
                return _r(
                  Dr(r.props, r.state.selectValue),
              ...
              (r.cx = function () {
                for (
                  ...
                  t[n] = arguments[n];
                return cn.apply(void 0, [r.props.classNamePrefix].concat(t));
              }),
              ...
              (r.getComponents = function () {
                return (e = r.props), oe(oe({}, Jn), e.components);
                var e;
              }),
              (r.buildCategorizedOptions = function () {
                return Dr(r.props, r.state.selectValue);
              }),
              (r.getCategorizedOptions = function () {
                return r.props.menuIsOpen ? r.buildCategorizedOptions() : [];
              }),
              (r.buildFocusableOptions = function () {
                return Fr(r.buildCategorizedOptions());
              }),
              (r.getFocusableOptions = function () {
                return r.props.menuIsOpen ? r.buildFocusableOptions() : [];
              }),
              (r.ariaOnChange = function (e, t) {
                r.setState({ ariaSelection: oe({ value: e }, t) });
              }),
              ...
              (r.state.instancePrefix =
                'react-select-' + (r.props.instanceId || ++Zr)),
              (r.state.selectValue = un(e.value)),
              ...
              (r.state.focusableOptionsWithIds = o),
                ...
                (r.state.focusedOptionId = Hr(o, i[a]));
            }
            return r;
          }
          return (
              ...
              [
                  ...
                  value: function () {
                    this.startListeningComposition(),
                      ...
                      this.props.menuIsOpen &&
                        ...
                        vn(this.menuListRef, this.focusedOptionRef);
                  }
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return N.createElement(
                      e,
                      ue({}, t, { innerProps: o, isDisabled: n, isFocused: r })
                    );
                  }
                },
                {
                  ...
                  value: function () {
                    var e = this,
                      ...
                      A = d.menuPlacement,
                      C = d.menuPosition,
                      x = d.menuPortalTarget,
                      E = d.menuShouldBlockScroll,
                      w = d.menuShouldScrollIntoView,
                      M = d.noOptionsMessage,
                      S = d.onMenuScrollToTop,
                    ...
                    if (this.hasOptions())
                      T = this.getCategorizedOptions().map(function (t) {
                        if ('group' === t.type) {
                          ...
                          return N.createElement(
                            ...
                            t.options.map(function (e) {
                              return I(e, ''.concat(a, '-').concat(e.index));
                            })
                          );
                        }
                        if ('option' === t.type)
                      ...
                      var R = g({ inputValue: h });
                      if (null === R) return null;
                      T = N.createElement(s, u, R);
                    } else {
                      var O = M({ inputValue: h });
                      if (null === O) return null;
                      T = N.createElement(l, u, O);
                    }
                    var j = {
                        minMenuHeight: v,
                        maxMenuHeight: y,
                      ...
                      L = N.createElement(Nn, ue({}, u, j), function (t) {
                        var n = t.ref,
                          r = t.placerProps,
                          a = r.placement,
                          s = r.maxHeight;
      ...
      Xr.defaultProps = zr;
      var qr = (0, N.forwardRef)(function (e, t) {
          var n = (function (e) {
            var t = e.defaultInputValue,
              ...
              f = e.value,
              h = le(e, ce),
              m = se((0, N.useState)(void 0 !== s ? s : n), 2),
              g = m[0],
              v = m[1],
              y = se((0, N.useState)(void 0 !== l ? l : o), 2),
              b = y[0],
              A = y[1],
              C = se((0, N.useState)(void 0 !== f ? f : a), 2),
              x = C[0],
              E = C[1],
              w = (0, N.useCallback)(
                function (e, t) {
          ...
          return N.createElement(Xr, ue({ ref: t }, n));
        }),
        Kr = qr;
      class Jr extends N.Component {
        static propTypes = { entity: q().object };
        addComponent = (e) => {
          let t = e.value;
          var n = this.props.entity;
          if (AFRAME.components[t].multiple) {
            const e = prompt(
              `Provide an ID for this component (e.g., 'foo' for ${t}__foo).`
            );
            t = e ? `${t}__${e}` : t;
          }
        ...
        getComponentsOptions() {
          const e = Object.keys(this.props.entity.components);
          var t = Object.keys(AFRAME.components)
            .filter(function (t) {
              return AFRAME.components[t].multiple || -1 === e.indexOf(t);
            })
            .sort()
            .map(function (e) {
      ...
      class no extends N.Component {
        static propTypes = {
          componentname: q().string.isRequired,
          entity: q().object,
        ...
        constructor(e) {
          super(e), (this.state = { value: this.props.value });
        }
        ...
        onChange = (e) => {
          ...
          this.setState({ value: t }),
            this.props.onChange && this.props.onChange(this.props.name, t);
        };
        render() {
      ...
      class ro extends N.Component {
        ...
        static defaultProps = { value: '#ffffff' };
        constructor(e) {
          super(e);
          var t = this.props.value;
          (this.color = new THREE.Color()),
            (this.state = { value: t, pickerValue: this.getHexString(t) });
        }
        setValue(e) {
        ...
        onKeyUp = (e) => {
          e.stopPropagation(), this.setValue(e.target.value);
        };
        onChangeText = (e) => {
      ...
      class io extends N.Component {
        ...
        constructor(e) {
          super(e),
            (this.state = {
              value: this.props.value,
              displayValue:
                'number' == typeof this.props.value
                  ? this.props.value.toFixed(this.props.precision)
                  : ''
            }),
            (this.input = N.createRef());
        }
        componentDidMount() {
          (this.distance = 0),
        ...
        onMouseMove = (e) => {
          const t = parseFloat(this.state.value),
            n = [e.clientX, e.clientY],
            r = n[0] - this.prevPointer[0] - (n[1] - this.prevPointer[1]);
          this.distance += r;
          let o =
            this.onMouseDownValue +
            ((this.distance / (e.shiftKey ? 5 : 50)) * this.props.step) / 2;
          (o = Math.min(this.props.max, Math.max(this.props.min, o))),
            t !== o && this.setValue(o),
        ...
        onMouseUp = () => {
          document.removeEventListener('mousemove', this.onMouseMove, !1),
            ...
            Math.abs(this.distance) < 2 &&
              (this.input.current.focus(), this.input.current.select());
        };
        setValue(e) {
          e !== this.state.value &&
            void 0 !== e &&
            ((e = 0 === this.props.precision ? parseInt(e) : parseFloat(e)),
            ...
            this.props.onChange &&
              this.props.onChange(this.props.name, parseFloat(e.toFixed(5))));
        }
        componentDidUpdate(e) {
      ...
      class ao extends N.Component {
        static propTypes = {
          componentname: q().string.isRequired,
          entity: q().object,
          name: q().string.isRequired,
          onChange: q().func,
          options: q().array.isRequired,
          value: q().string
        };
        constructor(e) {
          super(e);
          const t = this.props.value || '';
          this.state = { value: { value: t, label: t } };
        }
        onChange = (e) => {
        ...
        render() {
          const e = this.props.options.map((e) => ({ value: e, label: e }));
          return (0, K.jsx)(Kr, {
      ...
      class so extends N.Component {
        static propTypes = {
          ...
          name: q().string.isRequired,
          onChange: q().func,
          value: q().oneOfType([q().object, q().string])
        };
        static defaultProps = { value: '', mapName: 'nomap', dataURL: '' };
        constructor(e) {
          super(e),
        ...
        setValue(e) {
          ...
          this.setState({ value: c ? '#' + e.id : e, valueType: u, url: t });
        }
        notifyChanged = (e) => {
          this.props.onChange && this.props.onChange(this.props.name, e),
            this.setState({ value: e });
        ...
        onChange = (e) => {
          var t = e.target.value;
          this.setState({ value: t }), this.notifyChanged(t);
        };
        removeMap = () => {
          this.setValue(''), this.notifyChanged('');
        };
        openDialog = () => {
          r.emit('opentexturesmodal', this.state.value, (e) => {
            if (e) {
              var t = e.value;
              'asset' !== e.type &&
                (t =
                  ...
                  (function (e) {
                    ...
                    if (n) t = n.id;
                      ...
                      if (
                        ...
                        for (var r = 1; document.getElementById(t + '_' + r); )
                          r++;
                        t += '_' + r;
                      }
                      !(function (e, t, n) {
      ...
      class lo extends N.Component {
        static propTypes = {
          componentname: q().string,
          entity: q().object,
          onChange: q().func,
          value: q().object.isRequired
        };
        constructor(e) {
          super(e),
            (this.state = {
        ...
        onChange = (e, t) => {
          this.setState({ [e]: parseFloat(t.toFixed(5)) }, () => {
        ...
        render() {
          ...
          return (0, K.jsxs)('div', {
            className: 'vec4',
            children: [
              (0, K.jsx)(io, { name: 'x', value: this.state.x, ...e }),
              (0, K.jsx)(io, { name: 'y', value: this.state.y, ...e }),
              (0, K.jsx)(io, { name: 'z', value: this.state.z, ...e }),
              (0, K.jsx)(io, { name: 'w', value: this.state.w, ...e })
            ]
          });
        }
      }
      class co extends N.Component {
        ...
        constructor(e) {
          super(e), (this.state = { x: e.value.x, y: e.value.y, z: e.value.z });
        }
        onChange = (e, t) => {
          this.setState({ [e]: parseFloat(t.toFixed(5)) }, () => {
            this.props.onChange && this.props.onChange(e, this.state);
      ...
      class uo extends N.Component {
        ...
        constructor(e) {
          super(e), (this.state = { x: e.value.x, y: e.value.y });
        }
        onChange = (e, t) => {
          this.setState({ [e]: parseFloat(t.toFixed(5)) }, () => {
            this.props.onChange && this.props.onChange(e, this.state);
      ...
      class po extends N.Component {
        static propTypes = {
          ...
          entity: q().object.isRequired,
          isSingle: q().bool.isRequired,
          name: q().string.isRequired,
          schema: q().object.isRequired
        };
        constructor(e) {
          super(e), (this.id = e.componentname + ':' + e.name);
        }
        getWidget() {
          const e = this.props,
            t =
          ...
          if (e.schema.oneOf && e.schema.oneOf.length > 0)
            return (0, K.jsx)(ao, { ...o, options: e.schema.oneOf });
          if ('map' === n || t) return (0, K.jsx)(so, { ...o });
          switch (n) {
            case 'number':
              return (0, K.jsx)(io, { ...o, ...i });
            case 'int':
              return (0, K.jsx)(io, { ...o, ...i, precision: 0 });
            case 'vec2':
              return (0, K.jsx)(uo, { ...o });
            case 'vec3':
              return (0, K.jsx)(co, { ...o });
            ...
            default:
              return (
                'string' === e.schema.type &&
                  o.value &&
                  'string' != typeof o.value &&
                  (o.value = e.schema.stringify(o.value)),
                (0, K.jsx)(oo, { ...o })
              );
          }
        }
          ...
          const e = this.props,
            ...
            r = to({
              ...
              propertyRowDefined: e.isSingle
                ...
                : e.name in (e.entity.getDOMAttribute(e.componentname) || {})
            });
          return (0, K.jsxs)('div', {
            className: r,
            children: [
      ...
      class fo extends N.Component {
        static propTypes = {
          className: q().string,
          collapsed: q().bool,
          children: q().oneOfType([q().array, q().element]).isRequired,
          id: q().string
        };
        static defaultProps = { collapsed: !1 };
        constructor(e) {
          super(e), (this.state = { collapsed: this.props.collapsed });
        }
        toggleVisibility = (e) => {
          'A' !== e.target.nodeName &&
        ...
        render() {
          ...
          const t = to(e),
            n = to({ content: !0, hide: this.state.collapsed });
          return (0, K.jsxs)('div', {
            id: this.props.id,
            className: t,
            children: [
              (0, K.jsxs)('div', {
                ...
                children: [
                  (0, K.jsx)('div', { className: 'collapse-button' }),
      ...
      var ho = o(673),
        mo = o.n(ho);
      const go = AFRAME.schema.isSingleProperty;
      class vo extends N.Component {
        ...
        constructor(e) {
          super(e),
            (this.state = { entity: this.props.entity, name: this.props.name });
        }
        onEntityUpdate = (e) => {
          e.entity === this.props.entity &&
            e.component === this.props.name &&
            this.forceUpdate();
        };
        componentDidMount() {
          r.on('entityupdate', this.onEntityUpdate);
        }
        componentWillUnmount() {
          r.off('entityupdate', this.onEntityUpdate);
        }
        ...
        removeComponent = (e) => {
          ...
          e.stopPropagation(),
            confirm('Do you really want to remove component `' + t + '`?') &&
                ...
                (0, K.jsxs)('div', {
                  ...
                  children: [
                    (0, K.jsx)('span', {
                      ...
                      title: t || e,
                      children: (0, K.jsx)('span', { children: t || e })
                    }),
                    (0, K.jsxs)('div', {
                            ...
                            n.preventDefault(),
                              ...
                              mo()(
                                (function (e, t) {
                                  ...
                                  return `${t}="${AFRAME.utils.styleParser.stringify(n)}"`;
                                })(this.state.entity, (t || e).toLowerCase())
                              );
                          },
                          children: (0, K.jsx)(J, { icon: B })
                        }),
                        (0, K.jsx)('a', {
                          title: 'Remove component',
                          className: 'button',
                          onClick: this.removeComponent,
                          children: (0, K.jsx)(J, { icon: L })
                        })
                      ]
                    })
                  ]
      ...
      const yo = ['visible', 'position', 'scale', 'rotation'];
      class bo extends N.Component {
        static propTypes = { entity: q().object.isRequired };
        constructor(e) {
          super(e), (this.state = { mixins: this.getMixinValue() });
        }
        onEntityUpdate = (e) => {
          e.entity === this.props.entity &&
            'mixin' === e.component &&
        ...
        getMixinOptions = () => {
          const e = this.props.entity.mixinEls.map(function (e) {
            return e.id;
          });
        ...
        updateMixins = (e) => {
          const t = this.props.entity;
          this.setState({ mixins: e });
          const n = e.map((e) => e.value).join(' ');
          AFRAME.INSPECTOR.execute('entityupdate', {
            component: 'mixin',
            entity: t,
            value: n
        ...
        render() {
          return (0, K.jsx)('div', {
            ...
            children: (0, K.jsxs)('div', {
              ...
              children: [
                (0, K.jsx)('span', { className: 'text', children: 'mixins' }),
                (0, K.jsx)('span', {
      ...
      class Co extends N.Component {
        static propTypes = { entity: q().object, onDoubleClick: q().func };
        render() {
          ...
          for (let t in Ao)
            e.getObject3D(t) &&
              n.push((0, K.jsxs)('span', { children: [' ', Ao[t]] }, t));
          let r = e.id;
          21 === r.length && (r = '');
          let o = 'id';
          return (
            e.isScene || r || !e.getAttribute('class')
              ? e.isScene ||
                r ||
                !e.getAttribute('mixin') ||
                ((r = e.getAttribute('mixin').split(' ')[0]), (o = 'mixin'))
              : ((r = e.getAttribute('class').split(' ')[0]), (o = 'class')),
            (0, K.jsxs)('span', {
              ...
              children: [
                ...
                r &&
                  (0, K.jsxs)('span', {
                    ...
                    'data-entity-name-type': o,
                    children: [' ', r]
                  }),
                n.length > 0 &&
                  (0, K.jsx)('span', { className: 'entityIcons', children: n }),
                (0, K.jsx)('span', {
      ...
      function Eo(e, t) {
        var n = AFRAME.INSPECTOR.selectedEntity;
        n.id !== t &&
          AFRAME.INSPECTOR.execute('entityupdate', {
            component: 'id',
            entity: n,
      ...
      class wo extends N.Component {
        static propTypes = { entity: q().object };
        onEntityUpdate = (e) => {
          e.entity === this.props.entity &&
            ((-1 === yo.indexOf(e.component) &&
              'id' !== e.component &&
              'class' !== e.component &&
              'mixin' !== e.component) ||
              this.forceUpdate());
        ...
        renderCommonAttributes() {
          const e = this.props.entity;
          return ['position', 'rotation', 'scale', 'visible'].map((t) => {
            const n = AFRAME.components[t].schema;
            var r = e.object3D[t];
            return (
              'rotation' === t &&
                (r = {
        ...
        render() {
          const e = this.props.entity;
          if (!e) return (0, K.jsx)('div', {});
          const t = (0, K.jsxs)('div', {
            children: [
              (0, K.jsx)('a', {
                title: 'Export entity to GLTF',
                className: 'gltfIcon',
                onClick: (e) => {
                  this.exportToGLTF(), e.preventDefault(), e.stopPropagation();
                },
                children: (0, K.jsx)('img', { src: xo })
              }),
              (0, K.jsx)('a', {
          ...
          return (0, K.jsxs)(fo, {
            ...
            children: [
              (0, K.jsxs)('div', {
                ...
                children: [(0, K.jsx)(Co, { entity: e }), t]
              }),
              (0, K.jsxs)('div', {
                className: 'collapsible-content',
                children: [
                  ...
                  (0, K.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, K.jsx)('span', { children: e.getAttribute('class') })
                    ]
                  }),
      ...
      class So extends N.Component {
        static propTypes = { entity: q().object, visible: q().bool };
        onComponentRemove = (e) => {
          e.entity === this.props.entity && this.forceUpdate();
        };
        onComponentAdd = (e) => {
          e.entity === this.props.entity && this.forceUpdate();
        };
        componentDidMount() {
          r.on('componentremove', this.onComponentRemove),
            r.on('componentadd', this.onComponentAdd);
        }
        componentWillUnmount() {
          r.off('componentremove', this.onComponentRemove),
            r.off('componentadd', this.onComponentAdd);
        }
        render() {
          const e = this.props.entity,
          ...
          return e && t
            ? (0, K.jsx)('div', {
                id: 'sidebar',
                children: (0, K.jsx)(Mo, { entity: e })
              })
            : (0, K.jsx)('div', {});
        }
      }
      class ko extends N.Component {
        static propTypes = {
          id: q().string,
          children: q().oneOfType([q().array, q().element]).isRequired,
          isOpen: q().bool,
          extraCloseKeyCode: q().number,
          closeOnClickOutside: q().bool,
          onClose: q().func,
          title: q().string
        };
        static defaultProps = { closeOnClickOutside: !0 };
        constructor(e) {
          super(e),
            (this.state = { isOpen: this.props.isOpen }),
            (this.self = N.createRef());
        }
        componentDidMount() {
          ...
          this.state.isOpen &&
            (27 === e.keyCode ||
              (this.props.extraCloseKeyCode &&
                e.keyCode === this.props.extraCloseKeyCode)) &&
            (this.close(), e.stopPropagation());
        };
        shouldClickDismiss = (e) => {
          var t = e.target;
          return (
            ('INPUT' !== t.tagName || 'file' !== t.type) &&
            t !== this.self.current &&
            !this.self.current.contains(t)
          );
        };
        handleGlobalMousedown = (e) => {
          this.props.closeOnClickOutside &&
            this.state.isOpen &&
            this.shouldClickDismiss(e) &&
              ...
              children: [
                (0, K.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, K.jsx)('h3', { children: this.props.title })
                  ]
                }),
                (0, K.jsx)('div', {
      ...
      class Ro extends N.Component {
        ...
        constructor(e) {
          super(e),
            ...
            (this.imageName = N.createRef()),
            (this.preview = N.createRef()),
            (this.registryGallery = N.createRef());
        }
        onAssetsImagesLoad = (e) => {
          this.generateFromRegistry();
        };
        componentDidMount() {
          r.on('assetsimagesload', this.onAssetsImagesLoad),
            this.generateFromAssets();
        }
        componentWillUnmount() {
          r.off('assetsimagesload', this.onAssetsImagesLoad);
        }
        componentDidUpdate(e) {
          this.state.isOpen &&
        ...
        generateFromRegistry = () => {
          var e = this;
          AFRAME.INSPECTOR.assetsLoader.images.forEach((t) => {
            var n = new Image();
            n.addEventListener('load', () => {
              e.state.registryImages.push({
                ...
                e.setState({ registryImages: e.state.registryImages.slice() });
            }),
        ...
        onNewUrl = (e) => {
          if (13 === e.keyCode) {
            var t = this;
            this.preview.current.addEventListener('load', function e(n) {
              var r = t.preview.current.src;
              t.setState({
                preview: {
                  width: t.preview.current.naturalWidth,
                  height: t.preview.current.naturalHeight,
                  src: r,
                  id: '',
                  name: To(r, !0),
                  filename: To(r),
                ...
                t.preview.current.removeEventListener('load', e);
            }),
              (this.preview.current.src = e.target.value),
              this.imageName.current.focus();
          }
        };
        onNameKeyUp = (e) => {
          13 === e.keyCode && this.isValidAsset() && this.addNewAsset();
        };
        onNameChanged = (e) => {
          var t = this.state.preview;
          (t.name = e.target.value), this.setState({ preview: t });
        };
        toggleNewDialog = () => {
        ...
        isValidAsset() {
          let e = Io(this.state.preview.name);
        ...
        addNewAsset = () => {
          var e,
            ...
            r,
            o = this;
          (e = this.state.preview.name),
            (t = this.state.preview.src),
            (n = function () {
              o.generateFromAssets(),
                o.setState({ addNewDialogOpened: !1 }),
                o.clear();
            }),
            (r = null),
            ((r = document.createElement('img')).id = e),
            (r.src = t),
            ...
            r &&
              ...
              document.getElementsByTagName('a-assets')[0].appendChild(r));
        };
        onChangeFilter = (e) => {
        ...
        renderRegistryImages() {
          ...
          var n = this.state.filterText.toUpperCase();
                  ...
                  children: [
                    ...
                    (0, K.jsxs)('div', {
                      ...
                      children: [
                        ...
                        (0, K.jsx)('span', { children: To(e.src) }),
                        (0, K.jsxs)('span', {
        ...
        render() {
          let e = this.state.isOpen,
            t = this.state.preview,
            n = Io(this.state.preview.name),
            r = this.isValidAsset(),
            o = this.state.addNewDialogOpened ? 'BACK' : 'LOAD TEXTURE';
          return (0, K.jsxs)(ko, {
            id: 'textureModal',
            title: 'Textures',
            isOpen: e,
            ...
            children: [
                    ...
                    (0, K.jsxs)('div', {
                      ...
                      children: [
                        ...
                        (0, K.jsx)('input', {
                          ref: this.imageName,
                          className:
                            this.state.preview.name.length > 0 && !n
                              ? 'error'
                              : '',
                          type: 'text',
                        ...
                        (0, K.jsx)('img', {
                          ...
                          height: '155px',
                          src: t.src,
                          style: { visibility: t.src ? 'visible' : 'hidden' }
                        }),
              ...
              (0, K.jsx)('div', {
                ...
                children: (0, K.jsx)('ul', {
                  className: 'gallery',
                  children: this.state.assetsImages
                    .sort(function (e, t) {
                      return e.id > t.id;
                    })
                    .map(
                      function (e) {
                        let t = this.selectTexture.bind(this, e);
                        var n =
      ...
      class Oo extends N.Component {
        static propTypes = { isOpen: q().bool, onClose: q().func };
        constructor(e) {
          super(e), (this.state = { isOpen: this.props.isOpen });
        }
        static getDerivedStateFromProps(e, t) {
          return t.isOpen !== e.isOpen ? { isOpen: e.isOpen } : null;
        }
      ...
      class No extends N.Component {
        ...
        render() {
          return (0, K.jsx)(ko, {
            ...
            children: (0, K.jsxs)('div', {
              style: { fontSize: '1.2em', maxWidth: '500px' },
              children: [
                (0, K.jsx)('p', {
                ...
                (0, K.jsx)('div', {
                  ...
                  children: (0, K.jsx)('a', {
                    ...
                    children: 'Go to aframe editor repository and click Sponsor'
                  })
                })
              ]
            })
      ...
      class Po extends N.Component {
        static propTypes = {
          ...
          isSelected: q().bool,
          selectEntity: q().func,
          toggleExpandedCollapsed: q().func
        };
        onClick = () => this.props.selectEntity(this.props.entity);
        onDoubleClick = () => r.emit('objectfocus', this.props.entity.object3D);
        toggleVisibility = () => {
          const e = this.props.entity,
            t =
        ...
        render() {
          const e = this.props.isFiltering,
            t = this.props.isExpanded,
            n = this.props.entity,
            ...
            a = '&nbsp;&nbsp;&nbsp;&nbsp;'.repeat(this.props.depth);
          let s;
          s =
            n.children.length > 0 && !e
              ? (0, K.jsx)('span', {
                  onClick: () => this.props.toggleExpandedCollapsed(n),
                  className: 'collapsespace',
                  children: t
                    ? (0, K.jsx)(J, { icon: V })
                    : (0, K.jsx)(J, { icon: P })
                })
              : (0, K.jsx)('span', { className: 'collapsespace' });
          const l =
              'a-scene' === r ? n.object3D.visible : n.getAttribute('visible'),
            c = (0, K.jsx)('i', {
      ...
      class Bo extends N.Component {
        constructor(e) {
          super(e), (this.state = { isPlaying: !1, copied: !1 });
        }
        exportSceneToGLTF() {
          const e =
              AFRAME.scenes[0].id ||
        ...
        addEntity() {
          AFRAME.INSPECTOR.execute('entitycreate', { components: {} });
        }
        toggleScenePlaying = () => {
          if (this.state.isPlaying)
            return (
              ...
              void document.getElementById('aframeInspectorMouseCursor').play()
            );
              ...
              children: [
                ...
                (0, K.jsx)('a', {
                  ...
                  onClick: (e) => {
                    e.preventDefault(),
                      e.stopPropagation(),
                      mo()(g(document.querySelector('a-scene'))),
                ...
                (0, K.jsx)('div', {
                  ...
                  children: 'Copied a-scene HTML to clipboard'
                }),
                (0, K.jsx)('div', {
      ...
      class Do extends N.Component {
        static propTypes = {
          scene: q().object,
          selectedEntity: q().object,
          visible: q().bool
        };
        static defaultProps = { selectedEntity: '' };
        constructor(e) {
          super(e),
            (this.state = {
              entities: [],
            ...
            (this.updateFilteredEntities = Lo()(
        ...
        componentDidMount() {
          this.rebuildEntityOptions(),
            r.on('entitycreated', this.rebuildEntityOptions),
            r.on('entityclone', this.rebuildEntityOptions),
            r.on('entityremoved', this.rebuildEntityOptions),
            r.on('entityupdate', this.onEntityUpdate);
        }
        componentWillUnmount() {
          r.off('entitycreated', this.rebuildEntityOptions),
            r.off('entityclone', this.rebuildEntityOptions),
            r.off('entityremoved', this.rebuildEntityOptions),
            r.off('entityupdate', this.onEntityUpdate);
        }
        componentDidUpdate(e) {
        ...
        selectEntity = (e) => {
          let t = !1;
          for (let n = 0; n < this.state.filteredEntities.length; n++)
            this.state.filteredEntities[n].entity === e &&
              (this.setState({ selectedIndex: n }),
              setTimeout(() => {
                const e = document.getElementById('sgnode' + n),
                  t = document.querySelector('#scenegraph .outliner');
                if (!e || !t) return;
              ...
              this.expandToRoot(e),
              r.emit('entityselect', e),
              (t = !0));
          t || this.setState({ selectedIndex: -1 });
        };
        rebuildEntityOptions = () => {
          const e = [{ depth: 0, entity: this.props.scene }];
          !(function t(n, r) {
            if (n) {
              r += 1;
            ...
            this.setState({
              entities: e,
              filteredEntities: this.getFilteredEntities(this.state.filter, e)
            });
        };
        selectIndex = (e) => {
          e >= 0 &&
            e < this.state.entities.length &&
            this.selectEntity(this.state.entities[e].entity);
        };
        onFilterKeyUp = (e) => {
          27 === e.keyCode && this.clearFilter();
        };
        onKeyDown = (e) => {
          switch (e.keyCode) {
            case 37:
        ...
        onKeyUp = (e) => {
          if (null !== this.props.selectedEntity)
            switch (e.keyCode) {
              case 37:
                this.isExpanded(this.props.selectedEntity) &&
              ...
              case 40:
                this.selectIndex(
                  this.nextExpandedIndexTo(this.state.selectedIndex)
                );
            }
        };
        getFilteredEntities(e, t) {
          return (
              ...
              ? t.filter((t) =>
                  (function (e, t) {
                    return (
                      !t ||
                      !(
                        -1 === e.id.toUpperCase().indexOf(t.toUpperCase()) &&
                        -1 ===
                          e.tagName.toUpperCase().indexOf(t.toUpperCase()) &&
                        !e.classList.contains(t) &&
                        !e.matches(t)
                      )
                    );
                  })(t.entity, e || this.state.filter)
                )
              : t
          );
        }
        isVisibleInSceneGraph = (e) => {
          let t = e.parentNode;
          if (!t) return !1;
          for (; t?.isEntity; ) {
            if (!this.isExpanded(t)) return !1;
            t = t.parentNode;
          }
          return !0;
        };
        isExpanded = (e) => !0 === this.state.expandedElements.get(e);
        toggleExpandedCollapsed = (e) => {
          this.setState({
        ...
        expandToRoot = (e) => {
          ...
          for (; void 0 !== t && t.isEntity; )
            this.state.expandedElements.set(t, !0), (t = t.parentNode);
          this.setState({ expandedElements: this.state.expandedElements });
        };
        previousExpandedIndexTo = (e) => {
          for (let t = e - 1; t >= 0; t--) {
            const e = this.state.entities[t].entity;
            if (this.isVisibleInSceneGraph(e)) return t;
          }
          return -1;
        };
        nextExpandedIndexTo = (e) => {
          for (let t = e + 1; t < this.state.entities.length; t++) {
            const e = this.state.entities[t].entity;
            if (this.isVisibleInSceneGraph(e)) return t;
          }
          return -1;
        ...
        onChangeFilter = (e) => {
          ...
          this.setState({ filter: t }), this.updateFilteredEntities(t);
        };
        updateFilteredEntities(e) {
          this.setState({ filteredEntities: this.getFilteredEntities(e) });
        }
        clearFilter = () => {
          this.setState({ filter: '' }), this.updateFilteredEntities('');
        };
        renderEntities = () =>
          this.state.filteredEntities.map((e, t) =>
            this.isVisibleInSceneGraph(e.entity) || this.state.filter
              ? (0, N.createElement)(Po, {
                  ...e,
                  key: t,
                  isFiltering: !!this.state.filter,
                  isExpanded: this.isExpanded(e.entity),
                ...
                children: [
                  ...
                  (0, K.jsxs)('div', {
                    ...
                    children: [
                      ...
                      e,
                      !this.state.filter && (0, K.jsx)(J, { icon: Q })
                    ]
                  })
                ]
              }),
      ...
      class _o extends N.Component {
        constructor(e) {
          super(e),
            (this.state = { selectedCamera: 'perspective' }),
            (this.justChangedCamera = !1);
        }
        onCameraToggle = (e) => {
        ...
        componentDidMount() {
          r.on('cameratoggle', this.onCameraToggle);
        }
        componentWillUnmount() {
          r.off('cameratoggle', this.onCameraToggle);
        }
        onChange(e) {
          (this.justChangedCamera = !0),
            this.setState({ selectedCamera: e.value }),
            r.emit(e.event, e.payload);
        }
        render() {
          return (0, K.jsx)('div', {
            id: 'cameraToolbar',
            children: (0, K.jsx)(Kr, {
              ...
              simpleValue: !0,
              value:
                ((e = this.state.selectedCamera),
                Fo.filter((t) => t.value === e)[0]),
              isSearchable: !1,
      ...
      var Uo = [
        { value: 'translate', icon: (0, K.jsx)(J, { icon: U }) },
        { value: 'rotate', icon: (0, K.jsx)(J, { icon: W }) },
        {
          value: 'scale',
          icon: (0, K.jsx)(J, {
            icon: {
      ...
      class Ho extends N.Component {
        constructor(e) {
          super(e),
            (this.state = { selectedTransform: 'translate', localSpace: !1 });
        }
        onTransformModeChange = (e) => {
          this.setState({ selectedTransform: e });
        };
        ...
        componentDidMount() {
          r.on('transformmodechange', this.onTransformModeChange),
            r.on('transformspacechange', this.onTransformSpaceChange);
        }
        componentWillUnmount() {
          r.off('transformmodechange', this.onTransformModeChange),
            r.off('transformspacechange', this.onTransformSpaceChange);
        }
        changeTransformMode = (e) => {
          this.setState({ selectedTransform: e }),
            r.emit('transformmodechange', e);
        };
        onLocalChange = (e) => {
          const t = e.target.checked;
          this.setState({ localSpace: t }),
            r.emit('transformspacechanged', t ? 'local' : 'world');
        };
        renderTransformButtons = () =>
          Uo.map(
            function (e, t) {
              var n = e.value === this.state.selectedTransform,
                r = to({ button: !0, active: n });
              return (0, K.jsx)(
                'a',
                {
                  title: e.value,
      ...
      class Vo extends N.Component {
        constructor(e) {
          super(e), (this.state = { hoveredEntity: null });
        }
        onRaycasterMouseEnter = (e) => {
          this.setState({ hoveredEntity: e });
        };
        onRaycasterMouseLeave = (e) => {
          this.setState({ hoveredEntity: e });
        };
        componentDidMount() {
          r.on('raycastermouseenter', this.onRaycasterMouseEnter),
            r.on('raycastermouseleave', this.onRaycasterMouseLeave);
        }
        componentWillUnmount() {
          r.off('raycastermouseenter', this.onRaycasterMouseEnter),
            r.off('raycastermouseleave', this.onRaycasterMouseLeave);
        }
        render() {
          return (0, K.jsx)('div', {
            id: 'viewportHud',
            children: (0, K.jsx)('p', {
              children: (0, K.jsx)(Co, { entity: this.state.hoveredEntity })
            })
          });
        }
      }
      const Wo = () => {
        const [e, t] = (0, N.useState)(
            0 === AFRAME.INSPECTOR.history.undos.length
          ),
          [n, o] = (0, N.useState)(0 === AFRAME.INSPECTOR.history.redos.length);
        return (
          (0, N.useEffect)(() => {
            const e = () => {
              t(0 === AFRAME.INSPECTOR.history.undos.length),
                o(0 === AFRAME.INSPECTOR.history.redos.length);
            };
            return (
              r.on('historychanged', e),
              () => {
                r.off('historychanged', e);
              }
            );
          }, []),
          (0, K.jsxs)('div', {
      ...
      class Yo extends N.Component {
        constructor(e) {
          super(e),
            (this.state = {
              ...
              inspectorEnabled: !0,
              isHelpOpen: !1,
              isModalSponsorOpen: !1,
              isModalTexturesOpen: !1,
              sceneEl: AFRAME.scenes[0],
              visible: { scenegraph: !0, attributes: !0 }
            }),
            r.on('togglesidebar', (e) => {
              'all' === e.which
                ? this.state.visible.scenegraph || this.state.visible.attributes
                  ? this.setState({
        ...
        componentDidMount() {
          r.on(
            ...
            r.on('inspectortoggle', (e) => {
              this.setState({ inspectorEnabled: e });
            }),
            r.on('openhelpmodal', () => {
              this.setState({ isHelpOpen: !0 });
            });
        }
        onCloseHelpModal = (e) => {
          this.setState({ isHelpOpen: !1 });
        };
        onModalTextureOnClose = (e) => {
          this.setState({ isModalTexturesOpen: !1 }),
            this.state.textureOnClose && this.state.textureOnClose(e);
        };
        openModalSponsor = () => {
          this.setState({ isModalSponsorOpen: !0 });
        };
        onCloseModalSponsor = () => {
          this.setState({ isModalSponsorOpen: !1 });
        };
        toggleEdit = () => {
        ...
        renderComponentsToggle() {
          return this.state.inspectorEnabled &&
            ...
            ? (0, K.jsx)('div', {
                ...
                children: (0, K.jsx)('a', {
                  onClick: () => {
                    r.emit('togglesidebar', { which: 'attributes' });
                  },
        ...
        renderSceneGraphToggle() {
          return !this.state.inspectorEnabled || this.state.visible.scenegraph
            ? null
            : (0, K.jsx)('div', {
                className: 'toggle-sidebar left',
                children: (0, K.jsx)('a', {
                  onClick: () => {
                    r.emit('togglesidebar', { which: 'scenegraph' });
                  },
        ...
        render() {
          const e = this.state.sceneEl,
            t = this.state.inspectorEnabled ? 'Back to Scene' : 'Inspect Scene';
          return (0, K.jsxs)('div', {
            children: [
              (0, K.jsx)('a', {
              ...
              (0, K.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, K.jsxs)('div', {
                    ...
                    children: [
                      (0, K.jsxs)('div', {
                        id: 'undoAndCameraToolbar',
                        children: [(0, K.jsx)(Wo, {}), (0, K.jsx)(_o, {})]
                      }),
                      (0, K.jsx)(Vo, {}),
                      (0, K.jsx)(Ho, {})
                    ]
      ...
      function Go(e, t) {
        if ('OrthographicCamera' !== e.type) return;
        const n = $o[t];
      ...
      function Zo() {
        return { debugUndoRedo: !1, defaultParent: 'a-scene' };
      }
      class Xo {
        constructor(e) {
          (this.editor = e),
            ...
            (this.idCounter = 0),
            (this.historyDisabled = !1),
            r.on('sceneplayingtoggle', (e) => {
              this.historyDisabled = e;
            });
        }
        execute(e, t) {
          const n = this.undos[this.undos.length - 1],
            o = Date.now() - this.lastCmdTime;
          n &&
          n.updatable &&
          e.updatable &&
          n.entityId === e.entityId &&
          n.type === e.type &&
          n.component === e.component &&
          n.property === e.property &&
          o < 500
            ? (n.update(e), (e = n))
            : (this.undos.push(e), (e.id = ++this.idCounter)),
            (e.name = void 0 !== t ? t : e.name),
            e.execute(),
            (this.lastCmdTime = Date.now()),
            (this.redos = []),
            r.emit('historychanged', e);
        }
        undo() {
          if (this.historyDisabled)
            return void alert('Undo/Redo disabled while scene is playing.');
          let e;
          return (
            this.undos.length > 0 && (e = this.undos.pop()),
            void 0 !== e &&
              (e.undo(), this.redos.push(e), r.emit('historychanged', e)),
            e
          );
        }
        redo() {
          ...
          let e;
          return (
            this.redos.length > 0 && (e = this.redos.pop()),
            void 0 !== e &&
              (e.execute(), this.undos.push(e), r.emit('historychanged', e)),
            e
          );
        }
        clear() {
          (this.undos = []),
            (this.redos = []),
            (this.idCounter = 0),
            r.emit('historychanged', null);
        }
      }
      const qo = THREE;
      let Ko, Jo, ei, ti;
      function ni(e, t = 1 / 0, n = null) {
        Jo || (Jo = new qo.PlaneGeometry(2, 2, 1, 1)),
          ei ||
            (ei = new qo.ShaderMaterial({
              uniforms: { blitTexture: new qo.Uniform(e) },
              vertexShader:
                '\n\t\t\tvarying vec2 vUv;\n\t\t\tvoid main(){\n\t\t\t\tvUv = uv;\n\t\t\t\tgl_Position = vec4(position.xy * 1.0,0.,.999999);\n\t\t\t}',
              fragmentShader:
                '\n\t\t\tuniform sampler2D blitTexture; \n\t\t\tvarying vec2 vUv;\n\n\t\t\tvoid main(){ \n\t\t\t\tgl_FragColor = vec4(vUv.xy, 0, 1);\n\t\t\t\t\n\t\t\t\t#ifdef IS_SRGB\n\t\t\t\tgl_FragColor = sRGBTransferOETF( texture2D( blitTexture, vUv) );\n\t\t\t\t#else\n\t\t\t\tgl_FragColor = texture2D( blitTexture, vUv);\n\t\t\t\t#endif\n\t\t\t}'
            })),
          (ei.uniforms.blitTexture.value = e),
          (ei.defines.IS_SRGB = e.colorSpace == qo.SRGBColorSpace),
          (ei.needsUpdate = !0),
          ti || ((ti = new qo.Mesh(Jo, ei)), (ti.frustumCulled = !1));
        const r = new qo.PerspectiveCamera(),
          o = new qo.Scene();
        o.add(ti),
          null === n && (n = Ko = new qo.WebGLRenderer({ antialias: !1 }));
        ...
        const c = new qo.CanvasTexture(s);
        return (
          ...
          (c.wrapT = e.wrapT),
          (c.name = e.name),
          Ko && (Ko.forceContextLoss(), Ko.dispose(), (Ko = null)),
          c
        );
      }
      const ri = {
      ...
      const ii = 5120,
        ...
        li = 5123,
        ci = 34962,
        ui = 'KHR_mesh_quantization',
        pi = {};
      (pi[qo.NearestFilter] = 9728),
        (pi[qo.NearestMipmapNearestFilter] = 9984),
        (pi[qo.NearestMipmapLinearFilter] = 9986),
        (pi[qo.LinearFilter] = 9729),
        (pi[qo.LinearMipmapNearestFilter] = 9985),
        (pi[qo.LinearMipmapLinearFilter] = 9987),
        (pi[qo.ClampToEdgeWrapping] = 33071),
        (pi[qo.RepeatWrapping] = 10497),
        (pi[qo.MirroredRepeatWrapping] = 33648);
      const di = {
          scale: 'scale',
      ...
      class bi {
        constructor() {
          (this.plugins = []),
            ...
            (this.json = {
              asset: {
                version: '2.0',
                generator: 'THREE.GLTFExporter r' + qo.REVISION
              }
            }),
            (this.cache = {
              meshes: new Map(),
        ...
        buildMetalRoughTexture(e, t) {
          if (e === t) return e;
          function n(e) {
            return e.colorSpace === qo.SRGBColorSpace
              ? function (e) {
                  return e < 0.04045
                    ? 0.0773993808 * e
          ...
          console.warn(
            ...
            e instanceof qo.CompressedTexture && (e = ni(e)),
            t instanceof qo.CompressedTexture && (t = ni(t));
          ...
          const u = (e || t).clone();
          return (
            (u.source = new qo.Source(s)),
            (u.colorSpace = qo.NoColorSpace),
                ...
                : (0 === n
                    ...
                    : 1 === n
                      ...
                      : 2 === n
                        ...
                        : 3 === n && (r = e.getW(o)),
                  !0 === e.normalized &&
                    (r = qo.MathUtils.normalize(r, e.array))),
                5126 === t
                  ? c.setFloat32(u, r, !0)
                  : 5124 === t
                    ? c.setInt32(u, r, !0)
        ...
        processAccessor(e, t, n, r) {
          ...
          else if (e.array.constructor === Int16Array) i = si;
          else if (e.array.constructor === Uint16Array) i = li;
          else if (e.array.constructor === Int8Array) i = ii;
          else {
                  ...
                  : (0 === t
                      ...
                      : 1 === t
                        ...
                        : 2 === t
                          ...
                          : 3 === t && (n = e.getW(o)),
                    !0 === e.normalized &&
                      (n = qo.MathUtils.normalize(n, e.array))),
        ...
        processSampler(e) {
          ...
          const n = {
            magFilter: pi[e.magFilter],
            minFilter: pi[e.minFilter],
            wrapS: pi[e.wrapS],
            wrapT: pi[e.wrapT]
          };
        ...
        processTexture(e) {
          ...
          r.textures || (r.textures = []),
            e instanceof qo.CompressedTexture && (e = ni(e, t.maxTextureSize));
        ...
        processMaterial(e) {
          ...
          e.transparent
            ...
            e.side === qo.DoubleSide && (r.doubleSided = !0),
        ...
        processMesh(e) {
          ...
          for (let e in i.attributes) {
            ...
            'JOINTS_0' !== e ||
              ...
              (f = new qo.BufferAttribute(
                new Uint16Array(r),
                n.itemSize,
                n.normalized
              )));
            const o = this.processAccessor(f || n, i);
            null !== o &&
          ...
          if (
            (void 0 !== d && i.setAttribute('normal', d),
          ...
          if (h && 0 === i.groups.length) return null;
          let m = !1;
          if (h && null === i.index) {
            const e = [];
          ...
          const g = h ? e.material : [e.material],
            v = h
              ? i.groups
          ...
          for (let e = 0, n = v.length; e < n; e++) {
            ...
            if (
              ...
              (void 0 === v[e].start && void 0 === v[e].count) ||
                (r += ':' + v[e].start + ':' + v[e].count),
                t.attributes.has(r)
            ...
            const r = this.processMaterial(g[v[e].materialIndex]);
          ...
          return t.meshes.set(o, y), y;
        }
        detectMeshQuantization(e, t) {
          if (this.extensionsUsed[ui]) return;
          let n;
          ...
          ri[r] &&
            ri[r].includes(n) &&
            ((this.extensionsUsed[ui] = !0),
            (this.extensionsRequired[ui] = !0));
        }
        processCamera(e) {
          const t = this.json;
          t.cameras || (t.cameras = []);
          ...
          return (
            n
              ...
              : (r.perspective = {
                  ...
                  yfov: qo.MathUtils.degToRad(e.fov),
                  zfar: e.far <= 0 ? 0.001 : e.far,
                  znear: e.near < 0 ? 0 : e.near
                }),
        ...
        processAnimation(e, t) {
          ...
          const o = (e = oi.Utils.mergeMorphTargetTracks(e.clone(), t)).tracks,
            i = [],
            a = [];
          for (let e = 0; e < o.length; ++e) {
            const n = o[e],
              s = qo.PropertyBinding.parseTrackName(n.name);
            let l = qo.PropertyBinding.findNode(t, s.nodeName);
            const c = di[s.propertyName];
            if (
              ('bones' === s.objectName &&
                (l =
                  !0 === l.isSkinnedMesh
            ...
            c === di.morphTargetInfluences &&
              (d /= l.morphTargetInfluences.length),
              !0 ===
              n.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline
                ? ((p = 'CUBICSPLINE'), (d /= 3))
                : (p =
                    n.getInterpolation() === qo.InterpolateDiscrete
                      ? 'STEP'
                      : 'LINEAR'),
              a.push({
                input: this.processAccessor(new qo.BufferAttribute(n.times, u)),
                output: this.processAccessor(
                  new qo.BufferAttribute(n.values, d)
                ),
                interpolation: p
              }),
              i.push({
        ...
        processNode(e) {
          ...
          if (n.trs) {
            const t = e.quaternion.toArray(),
              ...
              r = e.scale.toArray();
            hi(t, [0, 0, 0, 1]) || (o.rotation = t),
              hi(n, [0, 0, 0]) || (o.translation = n),
              hi(r, [1, 1, 1]) || (o.scale = r);
          } else
        ...
        processInput(e) {
          ...
          for (let t = 0; t < e.length; t++)
            e[t] instanceof qo.Scene ? this.processScene(e[t]) : n.push(e[t]);
        ...
        writeNode(e, t) {
          ...
          for (let e = 0; e < r.count; e++)
            r.getMatrixAt(e, s),
              ...
              u.toArray(a, 3 * e);
          const p = {
            TRANSLATION: n.processAccessor(new qo.BufferAttribute(o, 3)),
            ROTATION: n.processAccessor(new qo.BufferAttribute(i, 4)),
            SCALE: n.processAccessor(new qo.BufferAttribute(a, 3))
          };
      ...
      oi.Utils = {
        ...
        mergeMorphTargetTracks: function (e, t) {
          ...
          for (let e = 0; e < o.length; ++e) {
            let i = o[e];
            const a = qo.PropertyBinding.parseTrackName(i.name),
              s = qo.PropertyBinding.findNode(t, a.nodeName);
            if (
            ...
            if (
              ...
              console.warn(
                ...
                (i = i.clone()),
                i.setInterpolation(qo.InterpolateLinear);
            }
      ...
      ($i.styleTagTransform = Yi()),
        ($i.setAttributes = Ui()),
        ($i.insert = Fi().bind(null, 'head')),
        ($i.domAPI = Bi()),
        ($i.insertStyleElement = Vi()),
        Pi()(Qi.A, $i),
        ...
        (Gi.prototype = {
          init: function () {
            this.sceneEl.camera
              ? ((this.container = document.querySelector('.a-canvas')),
                (function (e) {
                  const t = e.sceneEl,
                    n = (e.currentCameraEl = t.camera.el);
                  ...
                  const o = (e.camera = new THREE.PerspectiveCamera());
                  (o.far = 1e4),
                    (o.near = 0.01),
                    ...
                    t.object3D.add(o),
                    (t.camera = o);
                  const i = t.canvas.width / t.canvas.height,
                  ...
                  r.on('cameraperspectivetoggle', () => {
                    Go(e.camera, Qo),
                      (t.camera = e.camera = s.perspective),
                      r.emit('cameratoggle', {
                        camera: e.camera,
                        value: 'perspective'
                      });
                  }),
                    r.on('cameraorthographictoggle', (n) => {
                      Go(e.camera, Qo),
                        (t.camera = e.camera = s.ortho),
                        (Qo = n),
                        (function (e, t, n) {
                          const r = $o[t];
                          (e.left = r.left || -10 * n),
          ...
          initUI: function () {
            I.init(this), this.initEvents(), (this.selected = null);
            const t = document.createElement('div');
            (t.id = 'aframeInspector'),
              t.setAttribute('data-aframe-inspector', 'app'),
              document.body.appendChild(t),
              (0, e.H)(t).render((0, K.jsx)(Yo, {})),
              ...
              this.sceneEl.object3D.traverse((e) => {
                this.addHelper(e);
              }),
          ...
          removeObject: function (e) {
            this.removeHelpers(e), r.emit('objectremove', e);
          },
          ...
          removeHelpers: function (e) {
            e.traverse((e) => {
              const t = this.helpers[e.uuid];
              t &&
                (this.sceneHelpers.remove(t),
                t.dispose(),
                delete this.helpers[e.uuid],
                r.emit('helperremove', this.helpers[e.uuid]));
            });
          },
          selectEntity: function (e, t) {
            (this.selectedEntity = e),
              e ? this.select(e.object3D) : this.select(null),
              void 0 === t && r.emit('entityselect', e);
            for (const e in this.helpers) this.helpers[e].visible = !1;
            e !== this.sceneEl &&
              e &&
              e.object3D.traverse((e) => {
                this.helpers[e.uuid] && (this.helpers[e.uuid].visible = !0);
              });
          },
          initEvents: function () {
            this.sceneEl.removeAttribute('inspector'),
              ...
              r.on('entityselect', (e) => {
                this.selectEntity(e, !1);
              }),
              r.on('inspectortoggle', (e) => {
                (this.inspectorActive = e),
                  (this.sceneHelpers.visible = this.inspectorActive);
              }),
              document.addEventListener('child-detached', (e) => {
                const t = e.detail.el;
                AFRAME.INSPECTOR.removeObject(t.object3D);
              });
          },
          execute(e, t, n, r = void 0) {
            const o = O.get(e);
            if (o) return this.history.execute(new o(this, t, r), n);
            console.error(`Command ${e} not found`);
          },
          undo: function () {
            this.history.undo();
          },
          ...
          select: function (e) {
            this.selected !== e &&
              ((this.selected = e), r.emit('objectselect', e));
          },
          deselect: function () {
            this.select(null);
          },
          ...
          open: function (e) {
            (this.opened = !0),
              ...
              e && (this.selectEntity(e), r.emit('objectfocus', e.object3D)),
              (this.isFirstOpen = !1);
          },
          close: function () {
            (this.opened = !1),
              r.emit('inspectortoggle', !1),
