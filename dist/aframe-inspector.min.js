                    ...
                    if (0 === t.button || void 0 === t.button) {
                      ...
                      if (n) {
                        ...
                        s &&
                          ...
                          H.extractRotation(r.object.matrixWorld),
                    ...
                    if (!1 !== t) {
                      if (
                        ...
                        m.sub(g),
                          m.multiply(D),
                          'local' === r.space &&
                            (m.applyMatrix4(x.copy(H).invert()),
                          ...
                          null !== r.translationSnap &&
                            ...
                            'local' === r.space &&
                              r.object.position.applyMatrix4(H));
                      else if ('scale' === o)
                        m.sub(g),
                          m.multiply(D),
                          'local' === r.space &&
                        ...
                        if (
                          ...
                          'local' === r.space
                            ? (m.applyMatrix4(x.copy(H).invert()),
                              E.applyMatrix4(x.copy(H).invert()),
                              v.set(
                                Math.atan2(m.z, m.y),
                                Math.atan2(m.x, m.z),
                                Math.atan2(m.y, m.x)
      ...
      551: (e, t, n) => {
              ...
              switch (((e.finishedWork = o), (e.finishedLanes = r), t)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = ro(xc.bind(null, e, Hl, Wl), t);
                    break;
                  }
                  xc(e, Hl, Wl);
                  break;
                case 4:
                  ...
                  if (
                    ...
                    e.timeoutHandle = ro(xc.bind(null, e, Hl, Wl), r);
                    break;
                  }
                  xc(e, Hl, Wl);
                  break;
        ...
        function ac(e, t) {
          ...
          return (
            ...
            2 !== (e = vc(e, t)) && ((t = Hl), (Hl = n), null !== t && sc(t)),
            e
          );
        }
        function sc(e) {
        ...
        function kc(e, t, n) {
          ...
          null !== r && r.delete(t),
            ...
            Rl === e &&
              (Nl & n) === n &&
              (4 === Pl ||
              (3 === Pl && (130023424 & Nl) === Nl && 500 > qe() - Ul)
                ? fc(e, 0)
                : (Fl |= n)),
            oc(e, t);
        }
    ...
    (() => {
      ...
      O.set(
        ...
        class extends R {
          ...
          execute() {
            const e = document.querySelector(`#${this.entityId}:not(a-mixin)`);
            e &&
              (e.setAttribute(this.component, this.value),
              r.emit('componentadd', {
                entity: e,
          ...
          undo() {
            const e = document.querySelector(`#${this.entityId}:not(a-mixin)`);
            e &&
              (e.removeAttribute(this.component),
        ...
        O.set(
          ...
          class extends R {
            ...
            undo() {
              ...
              if (e) {
                e.parentNode.removeChild(e), r.emit('entityremoved', e);
          ...
          class extends R {
            ...
            execute() {
              ...
              const n = (function (e, t, n) {
                ...
                e,
                (e) => {
                  this.editor.selectEntity(e);
                },
                t
              );
              return (this.entityId = n.id), n;
            }
            undo() {
              const e = document.querySelector(
                `#${this.entityId}:not(a-mixin)`
        ...
        O.set(
          ...
          class extends R {
            ...
            undo() {
              const e = this.parentEl.children[this.index] ?? null;
              this.parentEl.insertBefore(this.entity, e),
          ...
          class extends R {
            ...
            execute() {
              ...
              e &&
                ...
                f(e, this.component, this.property, this.newValue),
            ...
            undo() {
              ...
              e &&
                (this.editor.selectedEntity &&
                  this.editor.selectedEntity !== e &&
                  this.editor.selectEntity(e),
                f(e, this.component, this.property, this.oldValue),
      ...
      function it(e) {
        return Ve(at('', null, null, null, [''], (e = Ue(e)), 0, [0], e));
      }
          ...
          function n(e) {
            ...
            if (
              ...
              (r.state.focusableOptionsWithIds = o),
                ...
                (r.state.focusedOptionId = Ur(o, i[a]));
            }
            return r;
          }
          return (
      ...
      var _o = [
        { value: 'translate', icon: (0, K.jsx)(J, { icon: H }) },
        ...
        ($i.prototype = {
          ...
          selectEntity: function (e, t) {
            (this.selectedEntity = e),
              ...
              e && void 0 === t && r.emit('entityselect', e);
          ...
          execute(e, t, n) {
            const r = O.get(e);
            if (r) return this.history.execute(new r(this, t), n);
